...
image: https://iconhelper.cn/svg/fontawesome/solid/hand-pointer.svg
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-hand-pointer fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-hand-pointer" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-hand-pointer"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-hand-pointer
    <copy-btn content="fas fa-hand-pointer" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/hand-point-up.html">Hand Pointing Up</router-link></span> <span class="next"><router-link to="/icon/regular/hand-pointer.html">Pointer (Hand)</router-link>→</span></p></div>

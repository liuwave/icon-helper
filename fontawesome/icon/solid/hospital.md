...
image: https://iconhelper.cn/svg/fontawesome/solid/hospital.svg

---

# hospital  <small style="font-size: 60%;font-weight: 100">医院</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-hospital</span> 
</span>
<br/>
<span>
unicode：
...
</span><br/><span>标签：<span class="badge-light badge"><router-link to="/tags/buildings.html">建筑物</router-link></span><span class="badge-light badge"><router-link to="/tags/health.html">健康</router-link></span><span class="badge-light badge"><router-link to="/tags/maps.html">地图</router-link></span><span class="badge-light badge"><router-link to="/tags/medical.html">医学</router-link></span><span class="badge-light badge"><router-link to="/tags/objects.html">物体</router-link></span></span>
<br/>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-hospital" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-hospital"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-hospital
    <copy-btn content="fas fa-hospital" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-hospital'></detail>
<div class="icon-detail__container">
<p>关于“<b>hospital</b>”的评论:</p>
</div>
<Vssue title="关于“hospital”的评论" />    
<div><p>图标hospital来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/horse-head.html">Horse Head</router-link></span> <span class="next"><router-link to="/icon/regular/hospital.html">hospital</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/subscript.html">subscript</router-link></span> <span class="next"><router-link to="/icon/solid/suitcase.html">Suitcase</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/fedora.html">Fedora</router-link></span> <span class="next"><router-link to="/icon/solid/fighter-jet.html">fighter-jet</router-link>→</span></p></div>

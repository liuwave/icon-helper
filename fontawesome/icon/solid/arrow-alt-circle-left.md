...
image: https://iconhelper.cn/svg/fontawesome/solid/arrow-alt-circle-left.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-arrow-alt-circle-left" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-arrow-alt-circle-left"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-arrow-alt-circle-left
    <copy-btn content="fas fa-arrow-alt-circle-left" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/arrow-alt-circle-down.html">Alternate Arrow Circle Down</router-link></span> <span class="next"><router-link to="/icon/regular/arrow-alt-circle-left.html">Alternate Arrow Circle Left</router-link>→</span></p></div>

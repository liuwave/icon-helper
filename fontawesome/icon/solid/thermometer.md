...
name: thermometer
zhTips: 温度计,新型冠状病毒,新冠肺炎,汞,状态,温度,体温计
tags: ["medical","pharmacy"]
pre: fas
search: covid-19,mercury,status,temperature
image: https://iconhelper.cn/svg/fontawesome/solid/thermometer.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-thermometer</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">f491</span> 
<copy-btn content='f491' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("f491", 16))' btn-title="复制U"></copy-btn>
...
<br/>
<span>别名：<span class="badge-light badge">covid-19</span><span class="badge-light badge">mercury</span><span class="badge-light badge">status</span><span class="badge-light badge">temperature</span></span><br/><span class="zh-detail">中文描述：<span class="badge-primary badge">温度计</span><span class="badge-primary badge">新型冠状病毒</span><span class="badge-primary badge">新冠肺炎</span><span class="badge-primary badge">汞</span><span class="badge-primary badge">状态</span><span class="badge-primary badge">温度</span><span class="badge-primary badge">体温计</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/fontawesome/solid/thermometer.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/fontawesome/solid/thermometer.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-thermometer" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-thermometer"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-thermometer
    <copy-btn content="fas fa-thermometer" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/themeisle.html">ThemeIsle</router-link></span> <span class="next"><router-link to="/icon/solid/thermometer-empty.html">Thermometer Empty</router-link>→</span></p></div>

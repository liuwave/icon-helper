...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/columns.html">Columns</router-link></span> <span class="next"><router-link to="/icon/regular/comment.html">comment</router-link>→</span></p></div>

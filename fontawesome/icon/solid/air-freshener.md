...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/affiliatetheme.html">affiliatetheme</router-link></span> <span class="next"><router-link to="/icon/brands/airbnb.html">Airbnb</router-link>→</span></p></div>

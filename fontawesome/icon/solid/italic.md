...
image: https://iconhelper.cn/svg/fontawesome/solid/italic.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-italic</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-italic fa-3x"></i>
  <i class="fas fa-italic fa-5x"></i>
  <i class="fas fa-italic fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-italic" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-italic"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-italic
    <copy-btn content="fas fa-italic" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-italic'></detail>
<div class="icon-detail__container">
<p>关于“<b>italic</b>”的评论:</p>
</div>
<Vssue title="关于“italic”的评论" />    
<div><p>图标italic来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/ioxhost.html">ioxhost</router-link></span> <span class="next"><router-link to="/icon/brands/itch-io.html">itch.io</router-link>→</span></p></div>

...
# location-arrow  <small style="font-size: 60%;font-weight: 100">位置箭头</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-location-arrow</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-location-arrow fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-location-arrow" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-location-arrow"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-location-arrow
    <copy-btn content="fas fa-location-arrow" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>location-arrow</b>”的评论:</p>
</div>
<Vssue title="关于“location-arrow”的评论" />    
<div><p>图标location-arrow来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/list-ul.html">list-ul</router-link></span> <span class="next"><router-link to="/icon/solid/lock.html">lock</router-link>→</span></p></div>

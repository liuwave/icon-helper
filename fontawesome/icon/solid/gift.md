...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ghost.html">Ghost</router-link></span> <span class="next"><router-link to="/icon/solid/gifts.html">Gifts</router-link>→</span></p></div>

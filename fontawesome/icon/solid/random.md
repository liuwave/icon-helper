...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/rainbow.html">Rainbow</router-link></span> <span class="next"><router-link to="/icon/brands/raspberry-pi.html">Raspberry Pi</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/stopwatch.html">Stopwatch</router-link></span> <span class="next"><router-link to="/icon/solid/store.html">Store</router-link>→</span></p></div>

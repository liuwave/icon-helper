...
image: https://iconhelper.cn/svg/fontawesome/solid/share-alt-square.svg

---

# Alternate Share Square  <small style="font-size: 60%;font-weight: 100">备用共享广场</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-share-alt-square</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  <i class="fas fa-share-alt-square fa-xs"></i>
  <i class="fas fa-share-alt-square fa-sm"></i>
  ...
  <i class="fas fa-share-alt-square fa-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-share-alt-square" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-share-alt-square" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-share-alt-square"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-share-alt-square
    <copy-btn content="fas fa-share-alt-square" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-share-alt-square'></detail>
<div class="icon-detail__container">
<p>关于“<b>Alternate Share Square</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate Share Square”的评论" />    
<div><p>图标Alternate Share Square来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/share-alt.html">Alternate Share</router-link></span> <span class="next"><router-link to="/icon/solid/share-square.html">Share Square</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/contao.html">Contao</router-link></span> <span class="next"><router-link to="/icon/solid/cookie-bite.html">Cookie Bite</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/thermometer-quarter.html">Thermometer 1/4 Full</router-link></span> <span class="next"><router-link to="/icon/brands/think-peaks.html">Think Peaks</router-link>→</span></p></div>

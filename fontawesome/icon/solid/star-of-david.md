...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/star-half-alt.html">Alternate Star Half</router-link></span> <span class="next"><router-link to="/icon/solid/star-of-life.html">Star of Life</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/times-circle.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-times-circle" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-times-circle"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-times-circle
    <copy-btn content="fas fa-times-circle" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/times.html">Times</router-link></span> <span class="next"><router-link to="/icon/regular/times-circle.html">Times Circle</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/laptop-house.html">Laptop House</router-link></span> <span class="next"><router-link to="/icon/brands/laravel.html">Laravel</router-link>→</span></p></div>

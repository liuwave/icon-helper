...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/grin-beam.html">Grinning Face With Smiling Eyes</router-link></span> <span class="next"><router-link to="/icon/regular/grin-beam-sweat.html">Grinning Face With Sweat</router-link>→</span></p></div>

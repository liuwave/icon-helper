...
image: https://iconhelper.cn/svg/fontawesome/solid/edit.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-edit" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-edit"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-edit
    <copy-btn content="fas fa-edit" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/edge.html">Edge Browser</router-link></span> <span class="next"><router-link to="/icon/regular/edit.html">Edit</router-link>→</span></p></div>

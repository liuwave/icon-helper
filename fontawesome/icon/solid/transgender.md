...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/tram.html">Tram</router-link></span> <span class="next"><router-link to="/icon/solid/transgender-alt.html">Alternate Transgender</router-link>→</span></p></div>

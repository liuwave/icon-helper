...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/gavel.html">Gavel</router-link></span> <span class="next"><router-link to="/icon/regular/gem.html">Gem</router-link>→</span></p></div>

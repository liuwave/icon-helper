...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/palfed.html">Palfed</router-link></span> <span class="next"><router-link to="/icon/solid/paper-plane.html">Paper Plane</router-link>→</span></p></div>

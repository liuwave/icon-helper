...
image: https://iconhelper.cn/svg/fontawesome/solid/search-plus.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-search-plus</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-search-plus fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-search-plus" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-search-plus"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-search-plus
    <copy-btn content="fas fa-search-plus" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-search-plus'></detail>
<div class="icon-detail__container">
<p>关于“<b>Search Plus</b>”的评论:</p>
</div>
<Vssue title="关于“Search Plus”的评论" />    
<div><p>图标Search Plus来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/search-minus.html">Search Minus</router-link></span> <span class="next"><router-link to="/icon/brands/searchengin.html">Searchengin</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/moon.html">Moon</router-link></span> <span class="next"><router-link to="/icon/solid/mosque.html">Mosque</router-link>→</span></p></div>

...
title: Code(代码) ICON转svg、png下载
name: code
zhTips: 代码,括号,开发,html
tags: ["code"]
pre: fas
search: brackets,code,development,html
image: https://iconhelper.cn/svg/fontawesome/solid/code.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-code</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-code" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-code"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-code
    <copy-btn content="fas fa-code" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-code'></detail>
<div class="icon-detail__container">
<p>关于“<b>Code</b>”的评论:</p>
</div>
<Vssue title="关于“Code”的评论" />    
<div><p>图标Code来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/cocktail.html">Cocktail</router-link></span> <span class="next"><router-link to="/icon/solid/code-branch.html">Code Branch</router-link>→</span></p></div>

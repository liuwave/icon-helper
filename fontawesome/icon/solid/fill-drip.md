...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/fill.html">Fill</router-link></span> <span class="next"><router-link to="/icon/solid/film.html">Film</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/grin-wink.html">Grinning Winking Face</router-link></span> <span class="next"><router-link to="/icon/solid/grip-lines.html">Grip Lines</router-link>→</span></p></div>

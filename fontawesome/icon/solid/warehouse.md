...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/wallet.html">Wallet</router-link></span> <span class="next"><router-link to="/icon/solid/water.html">Water</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/box-open.html">Box Open</router-link></span> <span class="next"><router-link to="/icon/solid/boxes.html">Boxes</router-link>→</span></p></div>

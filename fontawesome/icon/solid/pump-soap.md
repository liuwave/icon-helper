...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pump-medical.html">Pump Medical</router-link></span> <span class="next"><router-link to="/icon/brands/pushed.html">Pushed</router-link>→</span></p></div>

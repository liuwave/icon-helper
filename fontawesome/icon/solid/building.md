...
image: https://iconhelper.cn/svg/fontawesome/solid/building.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/bug.html">Bug</router-link></span> <span class="next"><router-link to="/icon/regular/building.html">Building</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/gitter.html">Gitter</router-link></span> <span class="next"><router-link to="/icon/solid/glass-martini.html">Martini Glass</router-link>→</span></p></div>

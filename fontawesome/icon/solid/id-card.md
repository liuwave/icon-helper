...
image: https://iconhelper.cn/svg/fontawesome/solid/id-card.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/id-badge.html">Identification Badge</router-link></span> <span class="next"><router-link to="/icon/regular/id-card.html">Identification Card</router-link>→</span></p></div>

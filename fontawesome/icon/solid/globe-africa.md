...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/globe.html">Globe</router-link></span> <span class="next"><router-link to="/icon/solid/globe-americas.html">Globe with Americas shown</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/frown.html">Frowning Face</router-link></span> <span class="next"><router-link to="/icon/regular/frown-open.html">Frowning Face With Open Mouth</router-link>→</span></p></div>

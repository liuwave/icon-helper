...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/rebel.html">Rebel Alliance</router-link></span> <span class="next"><router-link to="/icon/solid/record-vinyl.html">Record Vinyl</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/centos.html">Centos</router-link></span> <span class="next"><router-link to="/icon/solid/chair.html">Chair</router-link>→</span></p></div>

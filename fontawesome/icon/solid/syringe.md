...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sync-alt.html">Alternate Sync</router-link></span> <span class="next"><router-link to="/icon/solid/table.html">table</router-link>→</span></p></div>

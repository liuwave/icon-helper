...
image: https://iconhelper.cn/svg/fontawesome/solid/futbol.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/funnel-dollar.html">Funnel Dollar</router-link></span> <span class="next"><router-link to="/icon/regular/futbol.html">Futbol</router-link>→</span></p></div>

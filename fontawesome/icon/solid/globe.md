...
image: https://iconhelper.cn/svg/fontawesome/solid/globe.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-globe</span> 
</span>
<br/>
<span>
unicode：
...
</span><br/><span>标签：<span class="badge-light badge"><router-link to="/tags/business.html">商业</router-link></span><span class="badge-light badge"><router-link to="/tags/charity.html">慈善</router-link></span><span class="badge-light badge"><router-link to="/tags/maps.html">地图</router-link></span><span class="badge-light badge"><router-link to="/tags/objects.html">物体</router-link></span><span class="badge-light badge"><router-link to="/tags/science-fiction.html">科幻小说</router-link></span></span>
<br/>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-globe" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-globe"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-globe
    <copy-btn content="fas fa-globe" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-globe'></detail>
<div class="icon-detail__container">
<p>关于“<b>Globe</b>”的评论:</p>
</div>
<Vssue title="关于“Globe”的评论" />    
<div><p>图标Globe来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/glide-g.html">Glide G</router-link></span> <span class="next"><router-link to="/icon/solid/globe-africa.html">Globe with Africa shown</router-link>→</span></p></div>

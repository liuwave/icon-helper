...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/font-awesome-logo-full.html">Font Awesome Full Logo</router-link></span> <span class="next"><router-link to="/icon/brands/font-awesome-logo-full.html">Font Awesome Full Logo</router-link>→</span></p></div>

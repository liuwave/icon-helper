...
image: https://iconhelper.cn/svg/fontawesome/solid/compass.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-compass</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-compass" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-compass" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-compass"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-compass
    <copy-btn content="fas fa-compass" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-compass'></detail>
<div class="icon-detail__container">
<p>关于“<b>Compass</b>”的评论:</p>
</div>
<Vssue title="关于“Compass”的评论" />    
<div><p>图标Compass来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/compact-disc.html">Compact Disc</router-link></span> <span class="next"><router-link to="/icon/regular/compass.html">Compass</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/fist-raised.html">Raised Fist</router-link></span> <span class="next"><router-link to="/icon/regular/flag.html">flag</router-link>→</span></p></div>

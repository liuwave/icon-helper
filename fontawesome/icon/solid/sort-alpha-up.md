...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sort-alpha-down-alt.html">Alternate Sort Alphabetical Down</router-link></span> <span class="next"><router-link to="/icon/solid/sort-alpha-up-alt.html">Alternate Sort Alphabetical Up</router-link>→</span></p></div>

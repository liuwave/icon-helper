...
image: https://iconhelper.cn/svg/fontawesome/solid/address-card.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-address-card" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-address-card"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-address-card
    <copy-btn content="fas fa-address-card" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/address-book.html">Address Book</router-link></span> <span class="next"><router-link to="/icon/regular/address-card.html">Address Card</router-link>→</span></p></div>

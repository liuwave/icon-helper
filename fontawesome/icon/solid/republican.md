...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/replyd.html">replyd</router-link></span> <span class="next"><router-link to="/icon/brands/researchgate.html">Researchgate</router-link>→</span></p></div>

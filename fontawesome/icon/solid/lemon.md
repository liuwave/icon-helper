...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/leanpub.html">Leanpub</router-link></span> <span class="next"><router-link to="/icon/regular/lemon.html">Lemon</router-link>→</span></p></div>

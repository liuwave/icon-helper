...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/user-plus.html">User Plus</router-link></span> <span class="next"><router-link to="/icon/solid/user-shield.html">User Shield</router-link>→</span></p></div>

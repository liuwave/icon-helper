...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/chess-board.html">Chess Board</router-link></span> <span class="next"><router-link to="/icon/solid/chess-knight.html">Chess Knight</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/grin-tongue-squint.html">Squinting Face With Tongue</router-link></span> <span class="next"><router-link to="/icon/regular/grin-tongue-wink.html">Winking Face With Tongue</router-link>→</span></p></div>

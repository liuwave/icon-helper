...
image: https://iconhelper.cn/svg/fontawesome/solid/file-invoice.svg
...
<p>关于“<b>File Invoice</b>”的评论:</p>
</div>
<Vssue title="关于“File Invoice”的评论" />    
<div><p>图标File Invoice来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file-import.html">File Import</router-link></span> <span class="next"><router-link to="/icon/solid/file-invoice-dollar.html">File Invoice with US Dollar</router-link>→</span></p></div>

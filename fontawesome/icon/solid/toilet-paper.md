...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/toilet.html">Toilet</router-link></span> <span class="next"><router-link to="/icon/solid/toilet-paper-slash.html">Toilet Paper Slash</router-link>→</span></p></div>

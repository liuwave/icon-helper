...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/money-check.html">Money Check</router-link></span> <span class="next"><router-link to="/icon/solid/monument.html">Monument</router-link>→</span></p></div>

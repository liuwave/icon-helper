...
pre: fas
search: hold,wait
image: https://iconhelper.cn/svg/fontawesome/solid/pause.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-pause</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-pause" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-pause"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-pause
    <copy-btn content="fas fa-pause" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-pause'></detail>
<div class="icon-detail__container">
<p>关于“<b>pause</b>”的评论:</p>
</div>
<Vssue title="关于“pause”的评论" />    
<div><p>图标pause来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/patreon.html">Patreon</router-link></span> <span class="next"><router-link to="/icon/solid/pause-circle.html">Pause Circle</router-link>→</span></p></div>

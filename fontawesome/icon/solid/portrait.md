...
title: Portrait(肖像) ICON转svg、png下载
name: portrait
zhTips: 肖像,id,图像,照片,图片,自拍照
tags: ["images","users-people"]
pre: fas
search: id,image,photo,picture,selfie
image: https://iconhelper.cn/svg/fontawesome/solid/portrait.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-portrait</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">f3e0</span> 
<copy-btn content='f3e0' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("f3e0", 16))' btn-title="复制U"></copy-btn>
</span><br/><span>样式：<span class="badge-light badge">实心(solid)</span></span>
<br/>
<span>
版本：
<span class="badge-secondary badge">5.0.3</span> 
</span><br/><span>标签：<span class="badge-light badge"><router-link to="/tags/images.html">图像</router-link></span><span class="badge-light badge"><router-link to="/tags/users-people.html">用户 & 人员</router-link></span></span>
<br/>
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-portrait fa-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-portrait" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-portrait" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-portrait"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-portrait
    <copy-btn content="fas fa-portrait" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-portrait'></detail>
<div class="icon-detail__container">
<p>关于“<b>Portrait</b>”的评论:</p>
</div>
<Vssue title="关于“Portrait”的评论" />    
<div><p>图标Portrait来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/poop.html">Poop</router-link></span> <span class="next"><router-link to="/icon/solid/pound-sign.html">Pound Sign</router-link>→</span></p></div>

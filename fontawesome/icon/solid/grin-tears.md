...
image: https://iconhelper.cn/svg/fontawesome/solid/grin-tears.svg
...
<p>关于“<b>Face With Tears of Joy</b>”的评论:</p>
</div>
<Vssue title="关于“Face With Tears of Joy”的评论" />    
<div><p>图标Face With Tears of Joy来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/grin-stars.html">Star-Struck</router-link></span> <span class="next"><router-link to="/icon/regular/grin-tears.html">Face With Tears of Joy</router-link>→</span></p></div>

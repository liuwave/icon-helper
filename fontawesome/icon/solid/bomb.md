...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/bolt.html">Lightning Bolt</router-link></span> <span class="next"><router-link to="/icon/solid/bone.html">Bone</router-link>→</span></p></div>

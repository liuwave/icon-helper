...
name: check
zhTips: 检查,接受,同意,选中标记,确认,正确,完成,通知,确定,选择,成功,刻度线,待办事项,是,勾,审核,对号
tags: ["interfaces"]
pre: fas
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-check</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-check" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-check"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-check
    <copy-btn content="fas fa-check" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标Check来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/chart-pie.html">Pie Chart</router-link></span> <span class="next"><router-link to="/icon/solid/check-circle.html">Check Circle</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ad.html">Ad</router-link></span> <span class="next"><router-link to="/icon/regular/address-book.html">Address Book</router-link>→</span></p></div>

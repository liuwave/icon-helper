...
image: https://iconhelper.cn/svg/fontawesome/solid/luggage-cart.svg
...
<p>关于“<b>Luggage Cart</b>”的评论:</p>
</div>
<Vssue title="关于“Luggage Cart”的评论" />    
<div><p>图标Luggage Cart来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/low-vision.html">Low Vision</router-link></span> <span class="next"><router-link to="/icon/solid/lungs.html">Lungs</router-link>→</span></p></div>

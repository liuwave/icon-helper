...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/toggle-on.html">Toggle On</router-link></span> <span class="next"><router-link to="/icon/solid/toilet-paper.html">Toilet Paper</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/bullseye.html">Bullseye</router-link></span> <span class="next"><router-link to="/icon/brands/buromobelexperte.html">Büromöbel-Experte GmbH & Co. KG.</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/satellite.html">Satellite</router-link></span> <span class="next"><router-link to="/icon/solid/save.html">Save</router-link>→</span></p></div>

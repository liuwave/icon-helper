...
image: https://iconhelper.cn/svg/fontawesome/solid/hand-scissors.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/hand-rock.html">Rock (Hand)</router-link></span> <span class="next"><router-link to="/icon/regular/hand-scissors.html">Scissors (Hand)</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ban.html">ban</router-link></span> <span class="next"><router-link to="/icon/brands/bandcamp.html">Bandcamp</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/i-cursor.html">I Beam Cursor</router-link></span> <span class="next"><router-link to="/icon/solid/icicles.html">Icicles</router-link>→</span></p></div>

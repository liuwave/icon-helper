...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/critical-role.html">Critical Role</router-link></span> <span class="next"><router-link to="/icon/solid/crop-alt.html">Alternate Crop</router-link>→</span></p></div>

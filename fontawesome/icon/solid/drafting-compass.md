...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/draft2digital.html">Draft2digital</router-link></span> <span class="next"><router-link to="/icon/solid/dragon.html">Dragon</router-link>→</span></p></div>

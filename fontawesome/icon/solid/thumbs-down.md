...
image: https://iconhelper.cn/svg/fontawesome/solid/thumbs-down.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/think-peaks.html">Think Peaks</router-link></span> <span class="next"><router-link to="/icon/regular/thumbs-down.html">thumbs-down</router-link>→</span></p></div>

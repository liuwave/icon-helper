...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/deviantart.html">deviantART</router-link></span> <span class="next"><router-link to="/icon/brands/dhl.html">DHL</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/clone.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-clone" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-clone"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-clone
    <copy-btn content="fas fa-clone" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/clock.html">Clock</router-link></span> <span class="next"><router-link to="/icon/regular/clone.html">Clone</router-link>→</span></p></div>

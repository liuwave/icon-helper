...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pizza-slice.html">Pizza Slice</router-link></span> <span class="next"><router-link to="/icon/solid/plane.html">plane</router-link>→</span></p></div>

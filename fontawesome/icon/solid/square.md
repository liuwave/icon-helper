...
image: https://iconhelper.cn/svg/fontawesome/solid/square.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-square" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-square"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-square
    <copy-btn content="fas fa-square" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/spray-can.html">Spray Can</router-link></span> <span class="next"><router-link to="/icon/regular/square.html">Square</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/basketball-ball.html">Basketball Ball</router-link></span> <span class="next"><router-link to="/icon/solid/battery-empty.html">Battery Empty</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/assistive-listening-systems.html">Assistive Listening Systems</router-link></span> <span class="next"><router-link to="/icon/brands/asymmetrik.html">Asymmetrik, Ltd.</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/snowman.html">Snowman</router-link></span> <span class="next"><router-link to="/icon/solid/soap.html">Soap</router-link>→</span></p></div>

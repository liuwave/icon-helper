...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/mdb.html">Material Design for Bootstrap</router-link></span> <span class="next"><router-link to="/icon/brands/medapps.html">MedApps</router-link>→</span></p></div>

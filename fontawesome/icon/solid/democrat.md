...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/delicious.html">Delicious</router-link></span> <span class="next"><router-link to="/icon/brands/deploydog.html">deploy.dog</router-link>→</span></p></div>

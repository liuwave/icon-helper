...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/crosshairs.html">Crosshairs</router-link></span> <span class="next"><router-link to="/icon/solid/crown.html">Crown</router-link>→</span></p></div>

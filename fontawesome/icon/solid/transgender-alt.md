...
pre: fas
search: intersex
image: https://iconhelper.cn/svg/fontawesome/solid/transgender-alt.svg

---

# Alternate Transgender  <small style="font-size: 60%;font-weight: 100">替代跨性别</small>
...
<p>关于“<b>Alternate Transgender</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate Transgender”的评论" />    
<div><p>图标Alternate Transgender来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/transgender.html">Transgender</router-link></span> <span class="next"><router-link to="/icon/solid/trash.html">Trash</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ruler-combined.html">Ruler Combined</router-link></span> <span class="next"><router-link to="/icon/solid/ruler-vertical.html">Ruler Vertical</router-link>→</span></p></div>

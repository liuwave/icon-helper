...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/bomb.html">Bomb</router-link></span> <span class="next"><router-link to="/icon/solid/bong.html">Bong</router-link>→</span></p></div>

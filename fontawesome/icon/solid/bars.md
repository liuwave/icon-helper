...
# Bars  <small style="font-size: 60%;font-weight: 100">酒吧</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-bars</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-bars" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-bars"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-bars
    <copy-btn content="fas fa-bars" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标Bars来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/barcode.html">barcode</router-link></span> <span class="next"><router-link to="/icon/solid/baseball-ball.html">Baseball Ball</router-link>→</span></p></div>

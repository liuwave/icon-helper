...
image: https://iconhelper.cn/svg/fontawesome/solid/file-video.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-file-video" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-file-video" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-file-video"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-file-video
    <copy-btn content="fas fa-file-video" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file-upload.html">File Upload</router-link></span> <span class="next"><router-link to="/icon/regular/file-video.html">Video File</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/resolving.html">Resolving</router-link></span> <span class="next"><router-link to="/icon/solid/retweet.html">Retweet</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/neuter.html">Neuter</router-link></span> <span class="next"><router-link to="/icon/regular/newspaper.html">Newspaper</router-link>→</span></p></div>

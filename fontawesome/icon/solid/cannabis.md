...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/candy-cane.html">Candy Cane</router-link></span> <span class="next"><router-link to="/icon/solid/capsules.html">Capsules</router-link>→</span></p></div>

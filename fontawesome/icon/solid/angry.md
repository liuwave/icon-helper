...
image: https://iconhelper.cn/svg/fontawesome/solid/angry.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-angry" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-angry" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-angry"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-angry
    <copy-btn content="fas fa-angry" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Angry Face</b>”的评论:</p>
</div>
<Vssue title="关于“Angry Face”的评论" />    
<div><p>图标Angry Face来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

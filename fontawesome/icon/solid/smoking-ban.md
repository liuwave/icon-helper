...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/smoking.html">Smoking</router-link></span> <span class="next"><router-link to="/icon/solid/sms.html">SMS</router-link>→</span></p></div>

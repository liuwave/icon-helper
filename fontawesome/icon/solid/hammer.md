...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hamburger.html">Hamburger</router-link></span> <span class="next"><router-link to="/icon/solid/hamsa.html">Hamsa</router-link>→</span></p></div>

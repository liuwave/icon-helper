...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-file" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-file"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-file
    <copy-btn content="fas fa-file" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/figma.html">Figma</router-link></span> <span class="next"><router-link to="/icon/regular/file.html">File</router-link>→</span></p></div>

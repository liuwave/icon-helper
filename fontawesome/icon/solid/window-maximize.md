...
image: https://iconhelper.cn/svg/fontawesome/solid/window-maximize.svg
...
<div class="alert alert-dark">
  <i class="fas fa-window-maximize fa-xs"></i>
  ...
  <i class="fas fa-window-maximize fa-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-window-maximize" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-window-maximize" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-window-maximize"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-window-maximize
    <copy-btn content="fas fa-window-maximize" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/window-close.html">Window Close</router-link></span> <span class="next"><router-link to="/icon/regular/window-maximize.html">Window Maximize</router-link>→</span></p></div>

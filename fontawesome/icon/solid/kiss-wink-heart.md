...
image: https://iconhelper.cn/svg/fontawesome/solid/kiss-wink-heart.svg
...
<p>关于“<b>Face Blowing a Kiss</b>”的评论:</p>
</div>
<Vssue title="关于“Face Blowing a Kiss”的评论" />    
<div><p>图标Face Blowing a Kiss来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/kiss-beam.html">Kissing Face With Smiling Eyes</router-link></span> <span class="next"><router-link to="/icon/regular/kiss-wink-heart.html">Face Blowing a Kiss</router-link>→</span></p></div>

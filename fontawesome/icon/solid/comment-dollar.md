...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/comment-alt.html">Alternate Comment</router-link></span> <span class="next"><router-link to="/icon/solid/comment-dots.html">Comment Dots</router-link>→</span></p></div>

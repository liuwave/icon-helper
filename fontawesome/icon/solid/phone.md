...
image: https://iconhelper.cn/svg/fontawesome/solid/phone.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-phone</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-phone" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-phone"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-phone
    <copy-btn content="fas fa-phone" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
<div id="svg" class="svg-wrap">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"/></svg>
</div>
<detail full-name='fa-phone'></detail>
<div class="icon-detail__container">
<p>关于“<b>Phone</b>”的评论:</p>
</div>
<Vssue title="关于“Phone”的评论" />    
<div><p>图标Phone来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/phoenix-squadron.html">Phoenix Squadron</router-link></span> <span class="next"><router-link to="/icon/solid/phone-alt.html">Alternate Phone</router-link>→</span></p></div>

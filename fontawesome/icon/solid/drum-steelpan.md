...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/drum.html">Drum</router-link></span> <span class="next"><router-link to="/icon/solid/drumstick-bite.html">Drumstick with Bite Taken Out</router-link>→</span></p></div>

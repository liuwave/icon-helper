...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-moon" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-moon"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-moon
    <copy-btn content="fas fa-moon" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/monument.html">Monument</router-link></span> <span class="next"><router-link to="/icon/regular/moon.html">Moon</router-link>→</span></p></div>

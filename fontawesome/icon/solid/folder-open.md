...
image: https://iconhelper.cn/svg/fontawesome/solid/folder-open.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-folder-open" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-folder-open"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-folder-open
    <copy-btn content="fas fa-folder-open" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/folder-minus.html">Folder Minus</router-link></span> <span class="next"><router-link to="/icon/regular/folder-open.html">Folder Open</router-link>→</span></p></div>

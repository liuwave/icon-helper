...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/volume-up.html">Volume Up</router-link></span> <span class="next"><router-link to="/icon/solid/vr-cardboard.html">Cardboard VR</router-link>→</span></p></div>

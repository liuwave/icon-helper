...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-copy" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-copy"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-copy
    <copy-btn content="fas fa-copy" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/cookie-bite.html">Cookie Bite</router-link></span> <span class="next"><router-link to="/icon/regular/copy.html">Copy</router-link>→</span></p></div>

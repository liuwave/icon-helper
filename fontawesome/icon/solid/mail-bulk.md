...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/magnet.html">magnet</router-link></span> <span class="next"><router-link to="/icon/brands/mailchimp.html">Mailchimp</router-link>→</span></p></div>

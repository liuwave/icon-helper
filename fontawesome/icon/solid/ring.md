...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ribbon.html">Ribbon</router-link></span> <span class="next"><router-link to="/icon/solid/road.html">road</router-link>→</span></p></div>

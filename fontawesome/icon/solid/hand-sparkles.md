...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/hand-scissors.html">Scissors (Hand)</router-link></span> <span class="next"><router-link to="/icon/solid/hand-spock.html">Spock (Hand)</router-link>→</span></p></div>

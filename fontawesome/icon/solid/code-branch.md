...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/code.html">Code</router-link></span> <span class="next"><router-link to="/icon/brands/codepen.html">Codepen</router-link>→</span></p></div>

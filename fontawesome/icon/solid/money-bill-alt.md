...
image: https://iconhelper.cn/svg/fontawesome/solid/money-bill-alt.svg

---

# Alternate Money Bill  <small style="font-size: 60%;font-weight: 100">备用金融法案</small>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-money-bill-alt" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-money-bill-alt"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-money-bill-alt
    <copy-btn content="fas fa-money-bill-alt" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Alternate Money Bill</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate Money Bill”的评论" />    
<div><p>图标Alternate Money Bill来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/money-bill.html">Money Bill</router-link></span> <span class="next"><router-link to="/icon/regular/money-bill-alt.html">Alternate Money Bill</router-link>→</span></p></div>

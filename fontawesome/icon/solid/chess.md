...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/cheese.html">Cheese</router-link></span> <span class="next"><router-link to="/icon/solid/chess-bishop.html">Chess Bishop</router-link>→</span></p></div>

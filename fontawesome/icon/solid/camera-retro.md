...
image: https://iconhelper.cn/svg/fontawesome/solid/camera-retro.svg

---

# Retro Camera  <small style="font-size: 60%;font-weight: 100">复古相机</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-camera-retro</span> 
</span>
<br/>
<span>
unicode：
...
</span><br/><span>标签：<span class="badge-light badge"><router-link to="/tags/images.html">图像</router-link></span><span class="badge-light badge"><router-link to="/tags/objects.html">物体</router-link></span><span class="badge-light badge"><router-link to="/tags/payments-shopping.html">支付&购物</router-link></span></span>
<br/>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-camera-retro" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-camera-retro"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-camera-retro
    <copy-btn content="fas fa-camera-retro" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-camera-retro'></detail>
<div class="icon-detail__container">
<p>关于“<b>Retro Camera</b>”的评论:</p>
</div>
<Vssue title="关于“Retro Camera”的评论" />    
<div><p>图标Retro Camera来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/camera.html">camera</router-link></span> <span class="next"><router-link to="/icon/solid/campground.html">Campground</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/underline.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-underline</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-underline fa-3x"></i>
  <i class="fas fa-underline fa-5x"></i>
  <i class="fas fa-underline fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-underline" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-underline"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-underline
    <copy-btn content="fas fa-underline" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
<div id="svg" class="svg-wrap">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M32 64h32v160c0 88.22 71.78 160 160 160s160-71.78 160-160V64h32a16 16 0 0 0 16-16V16a16 16 0 0 0-16-16H272a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16h32v160a80 80 0 0 1-160 0V64h32a16 16 0 0 0 16-16V16a16 16 0 0 0-16-16H32a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16zm400 384H16a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16v-32a16 16 0 0 0-16-16z"/></svg>
</div>
<detail full-name='fa-underline'></detail>
<div class="icon-detail__container">
<p>关于“<b>Underline</b>”的评论:</p>
</div>
<Vssue title="关于“Underline”的评论" />    
<div><p>图标Underline来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/umbrella-beach.html">Umbrella Beach</router-link></span> <span class="next"><router-link to="/icon/solid/undo.html">Undo</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pager.html">Pager</router-link></span> <span class="next"><router-link to="/icon/solid/paint-roller.html">Paint Roller</router-link>→</span></p></div>

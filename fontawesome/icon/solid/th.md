...
image: https://iconhelper.cn/svg/fontawesome/solid/th.svg

---

# th  <small style="font-size: 60%;font-weight: 100">块</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-th</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-th" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-th"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-th
    <copy-btn content="fas fa-th" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-th'></detail>
<div class="icon-detail__container">
<p>关于“<b>th</b>”的评论:</p>
</div>
<Vssue title="关于“th”的评论" />    
<div><p>图标th来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/text-width.html">Text Width</router-link></span> <span class="next"><router-link to="/icon/solid/th-large.html">th-large</router-link>→</span></p></div>

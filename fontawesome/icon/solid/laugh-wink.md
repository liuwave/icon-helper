...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/laugh-squint.html">Laughing Squinting Face</router-link></span> <span class="next"><router-link to="/icon/regular/laugh-wink.html">Laughing Winking Face</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/map.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-map" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-map"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-map
    <copy-btn content="fas fa-map" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-map'></detail>
<div class="icon-detail__container">
<p>关于“<b>Map</b>”的评论:</p>
</div>
<Vssue title="关于“Map”的评论" />    
<div><p>图标Map来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/mandalorian.html">Mandalorian</router-link></span> <span class="next"><router-link to="/icon/regular/map.html">Map</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/house-damage.html">Damaged House</router-link></span> <span class="next"><router-link to="/icon/brands/houzz.html">Houzz</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/street-view.html">Street View</router-link></span> <span class="next"><router-link to="/icon/brands/stripe.html">Stripe</router-link>→</span></p></div>

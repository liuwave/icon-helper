...
image: https://iconhelper.cn/svg/fontawesome/solid/rss-square.svg

---

# RSS Square  <small style="font-size: 60%;font-weight: 100">RSS广场</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-rss-square</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-rss-square" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-rss-square"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-rss-square
    <copy-btn content="fas fa-rss-square" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-rss-square'></detail>
<div class="icon-detail__container">
<p>关于“<b>RSS Square</b>”的评论:</p>
</div>
<Vssue title="关于“RSS Square”的评论" />    
<div><p>图标RSS Square来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/rss.html">rss</router-link></span> <span class="next"><router-link to="/icon/solid/ruble-sign.html">Ruble Sign</router-link>→</span></p></div>

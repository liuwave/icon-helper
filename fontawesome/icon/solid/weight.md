...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/weibo.html">Weibo</router-link></span> <span class="next"><router-link to="/icon/solid/weight-hanging.html">Hanging Weight</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/angle-up.svg

---

# angle-up  <small style="font-size: 60%;font-weight: 100">向上倾斜</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-angle-up</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-angle-up" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-angle-up"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-angle-up
    <copy-btn content="fas fa-angle-up" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
<div id="svg" class="svg-wrap">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M177 159.7l136 136c9.4 9.4 9.4 24.6 0 33.9l-22.6 22.6c-9.4 9.4-24.6 9.4-33.9 0L160 255.9l-96.4 96.4c-9.4 9.4-24.6 9.4-33.9 0L7 329.7c-9.4-9.4-9.4-24.6 0-33.9l136-136c9.4-9.5 24.6-9.5 34-.1z"/></svg>
</div>
<detail full-name='fa-angle-up'></detail>
<div class="icon-detail__container">
<p>关于“<b>angle-up</b>”的评论:</p>
</div>
<Vssue title="关于“angle-up”的评论" />    
<div><p>图标angle-up来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/angle-right.html">angle-right</router-link></span> <span class="next"><router-link to="/icon/solid/angry.html">Angry Face</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/external-link-square-alt.html">Alternate External Link Square</router-link></span> <span class="next"><router-link to="/icon/regular/eye.html">Eye</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/spotify.html">Spotify</router-link></span> <span class="next"><router-link to="/icon/solid/square.html">Square</router-link>→</span></p></div>

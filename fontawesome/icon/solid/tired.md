...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/tint-slash.html">Tint Slash</router-link></span> <span class="next"><router-link to="/icon/regular/tired.html">Tired Face</router-link>→</span></p></div>

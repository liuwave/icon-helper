...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/school.html">School</router-link></span> <span class="next"><router-link to="/icon/brands/scribd.html">Scribd</router-link>→</span></p></div>

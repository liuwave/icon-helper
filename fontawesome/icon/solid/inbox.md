...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/imdb.html">IMDB</router-link></span> <span class="next"><router-link to="/icon/solid/indent.html">Indent</router-link>→</span></p></div>

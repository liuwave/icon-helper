...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/periscope.html">Periscope</router-link></span> <span class="next"><router-link to="/icon/brands/phabricator.html">Phabricator</router-link>→</span></p></div>

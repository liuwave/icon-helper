...
# Chevron Circle Left  <small style="font-size: 60%;font-weight: 100">Chevron Circle左</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-chevron-circle-left</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-chevron-circle-left fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-chevron-circle-left" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-chevron-circle-left"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-chevron-circle-left
    <copy-btn content="fas fa-chevron-circle-left" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Chevron Circle Left</b>”的评论:</p>
</div>
<Vssue title="关于“Chevron Circle Left”的评论" />    
<div><p>图标Chevron Circle Left来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/mendeley.html">Mendeley</router-link></span> <span class="next"><router-link to="/icon/solid/mercury.html">Mercury</router-link>→</span></p></div>

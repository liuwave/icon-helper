...
image: https://iconhelper.cn/svg/fontawesome/solid/comment-dots.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-comment-dots" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-comment-dots"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-comment-dots
    <copy-btn content="fas fa-comment-dots" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/comment-dollar.html">Comment Dollar</router-link></span> <span class="next"><router-link to="/icon/regular/comment-dots.html">Comment Dots</router-link>→</span></p></div>

...
name: list-alt
zhTips: 备用清单,清单,完成,ol,待办事项,ul,列表,新闻,规则,LOG
tags: ["editors"]
pre: fas
search: checklist,completed,done,finished,ol,todo,ul
image: https://iconhelper.cn/svg/fontawesome/solid/list-alt.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-list-alt" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-list-alt"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-list-alt
    <copy-btn content="fas fa-list-alt" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Alternate List</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate List”的评论" />    
<div><p>图标Alternate List来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/list.html">List</router-link></span> <span class="next"><router-link to="/icon/regular/list-alt.html">Alternate List</router-link>→</span></p></div>

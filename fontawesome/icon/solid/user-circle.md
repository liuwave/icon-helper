...
image: https://iconhelper.cn/svg/fontawesome/solid/user-circle.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-user-circle" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-user-circle"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-user-circle
    <copy-btn content="fas fa-user-circle" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>User Circle</b>”的评论:</p>
</div>
<Vssue title="关于“User Circle”的评论" />    
<div><p>图标User Circle来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/user-check.html">User Check</router-link></span> <span class="next"><router-link to="/icon/regular/user-circle.html">User Circle</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/calendar-plus.svg
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-calendar-plus fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-calendar-plus" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-calendar-plus"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-calendar-plus
    <copy-btn content="fas fa-calendar-plus" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标Calendar Plus来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/calendar-minus.html">Calendar Minus</router-link></span> <span class="next"><router-link to="/icon/regular/calendar-plus.html">Calendar Plus</router-link>→</span></p></div>

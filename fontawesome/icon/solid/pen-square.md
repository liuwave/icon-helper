...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pen-nib.html">Pen Nib</router-link></span> <span class="next"><router-link to="/icon/solid/pencil-alt.html">Alternate Pencil</router-link>→</span></p></div>

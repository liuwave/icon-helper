...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/lock.html">lock</router-link></span> <span class="next"><router-link to="/icon/solid/long-arrow-alt-down.html">Alternate Long Arrow Down</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hospital-user.html">Hospital with User</router-link></span> <span class="next"><router-link to="/icon/solid/hotdog.html">Hot Dog</router-link>→</span></p></div>

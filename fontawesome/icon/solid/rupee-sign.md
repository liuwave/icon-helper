...
image: https://iconhelper.cn/svg/fontawesome/solid/rupee-sign.svg

---

# Indian Rupee Sign  <small style="font-size: 60%;font-weight: 100">印度卢比符号</small>
...
<p>关于“<b>Indian Rupee Sign</b>”的评论:</p>
</div>
<Vssue title="关于“Indian Rupee Sign”的评论" />    
<div><p>图标Indian Rupee Sign来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/running.html">Running</router-link></span> <span class="next"><router-link to="/icon/solid/sad-cry.html">Crying Face</router-link>→</span></p></div>

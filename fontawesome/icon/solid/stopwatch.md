...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/stop-circle.html">Stop Circle</router-link></span> <span class="next"><router-link to="/icon/solid/stopwatch-20.html">Stopwatch 20</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/industry.html">Industry</router-link></span> <span class="next"><router-link to="/icon/solid/info.html">Info</router-link>→</span></p></div>

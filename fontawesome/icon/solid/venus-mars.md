...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/venus-double.html">Venus Double</router-link></span> <span class="next"><router-link to="/icon/brands/viacoin.html">Viacoin</router-link>→</span></p></div>

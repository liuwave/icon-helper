...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/amilia.html">Amilia</router-link></span> <span class="next"><router-link to="/icon/brands/android.html">Android</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/angular.html">Angular</router-link></span> <span class="next"><router-link to="/icon/brands/app-store.html">App Store</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/cloud-moon.html">Cloud with Moon</router-link></span> <span class="next"><router-link to="/icon/solid/cloud-rain.html">Cloud with Rain</router-link>→</span></p></div>

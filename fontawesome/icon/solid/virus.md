...
image: https://iconhelper.cn/svg/fontawesome/solid/virus.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-virus</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">f974</span> 
<copy-btn content='f974' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("f974", 16))' btn-title="复制U"></copy-btn>
...
<div class="alert alert-dark">
  <i class="fas fa-virus fa-xs"></i>
  <i class="fas fa-virus fa-sm"></i>
  <i class="fas fa-virus fa-lg"></i>
  <i class="fas fa-virus fa-2x"></i>
  <i class="fas fa-virus fa-3x"></i>
  <i class="fas fa-virus fa-5x"></i>
  <i class="fas fa-virus fa-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-virus" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-virus" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-virus"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-virus
    <copy-btn content="fas fa-virus" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-virus'></detail>
<div class="icon-detail__container">
<p>关于“<b>Virus</b>”的评论:</p>
</div>
<Vssue title="关于“Virus”的评论" />    
<div><p>图标Virus来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/vine.html">Vine</router-link></span> <span class="next"><router-link to="/icon/solid/virus-slash.html">Virus Slash</router-link>→</span></p></div>

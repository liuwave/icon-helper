...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/keybase.html">Keybase</router-link></span> <span class="next"><router-link to="/icon/regular/keyboard.html">Keyboard</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/minus-square.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-minus-square" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-minus-square"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-minus-square
    <copy-btn content="fas fa-minus-square" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Minus Square</b>”的评论:</p>
</div>
<Vssue title="关于“Minus Square”的评论" />    
<div><p>图标Minus Square来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

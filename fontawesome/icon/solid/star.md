...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/stamp.html">Stamp</router-link></span> <span class="next"><router-link to="/icon/regular/star.html">Star</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/shield-virus.html">Shield Virus</router-link></span> <span class="next"><router-link to="/icon/solid/shipping-fast.html">Shipping Fast</router-link>→</span></p></div>

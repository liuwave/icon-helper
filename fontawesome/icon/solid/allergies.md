...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/alipay.html">Alipay</router-link></span> <span class="next"><router-link to="/icon/brands/amazon.html">Amazon</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/balance-scale-right.html">Balance Scale (Right-Weighted)</router-link></span> <span class="next"><router-link to="/icon/solid/band-aid.html">Band-Aid</router-link>→</span></p></div>

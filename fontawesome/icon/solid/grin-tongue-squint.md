...
image: https://iconhelper.cn/svg/fontawesome/solid/grin-tongue-squint.svg
...
<br/>
<span>别名：<span class="badge-light badge">LOL</span><span class="badge-light badge">emoticon</span><span class="badge-light badge">face</span></span><br/><span class="zh-detail">中文描述：<span class="badge-primary badge">用舌头S着眼睛</span><span class="badge-primary badge">笑声</span><span class="badge-primary badge">表情符号</span><span class="badge-primary badge">脸部</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/fontawesome/solid/grin-tongue-squint.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/fontawesome/solid/grin-tongue-squint.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div>
<div class="alert alert-dark">
  <i class="fas fa-grin-tongue-squint fa-xs"></i>
  <i class="fas fa-grin-tongue-squint fa-sm"></i>
  <i class="fas fa-grin-tongue-squint fa-lg"></i>
  <i class="fas fa-grin-tongue-squint fa-2x"></i>
  <i class="fas fa-grin-tongue-squint fa-3x"></i>
  <i class="fas fa-grin-tongue-squint fa-5x"></i>
  <i class="fas fa-grin-tongue-squint fa-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="fas fa-grin-tongue-squint" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="fas fa-grin-tongue-squint" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-grin-tongue-squint"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-grin-tongue-squint
    <copy-btn content="fas fa-grin-tongue-squint" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/grin-tongue.html">Face With Tongue</router-link></span> <span class="next"><router-link to="/icon/regular/grin-tongue-squint.html">Squinting Face With Tongue</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/head-side-virus.html">Head Side Virus</router-link></span> <span class="next"><router-link to="/icon/solid/headphones.html">headphones</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/backward.svg

---

# backward  <small style="font-size: 60%;font-weight: 100">向后</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-backward</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-backward fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-backward" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-backward"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-backward
    <copy-btn content="fas fa-backward" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-backward'></detail>
<div class="icon-detail__container">
<p>关于“<b>backward</b>”的评论:</p>
</div>
<Vssue title="关于“backward”的评论" />    
<div><p>图标backward来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/backspace.html">Backspace</router-link></span> <span class="next"><router-link to="/icon/solid/bacon.html">Bacon</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hockey-puck.html">Hockey Puck</router-link></span> <span class="next"><router-link to="/icon/solid/home.html">home</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/wikipedia-w.html">Wikipedia W</router-link></span> <span class="next"><router-link to="/icon/solid/window-close.html">Window Close</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sleigh.html">Sleigh</router-link></span> <span class="next"><router-link to="/icon/brands/slideshare.html">Slideshare</router-link>→</span></p></div>

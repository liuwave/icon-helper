...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hand-middle-finger.html">Hand with Middle Finger Raised</router-link></span> <span class="next"><router-link to="/icon/regular/hand-paper.html">Paper (Hand)</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/tablet-alt.html">Alternate Tablet</router-link></span> <span class="next"><router-link to="/icon/solid/tachometer-alt.html">Alternate Tachometer</router-link>→</span></p></div>

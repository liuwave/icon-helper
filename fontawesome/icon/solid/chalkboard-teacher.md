...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/chalkboard.html">Chalkboard</router-link></span> <span class="next"><router-link to="/icon/solid/charging-station.html">Charging Station</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/meh-rolling-eyes.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/meh-blank.html">Face Without Mouth</router-link></span> <span class="next"><router-link to="/icon/regular/meh-rolling-eyes.html">Face With Rolling Eyes</router-link>→</span></p></div>

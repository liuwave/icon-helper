...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/fire-alt.html">Alternate Fire</router-link></span> <span class="next"><router-link to="/icon/brands/firefox.html">Firefox</router-link>→</span></p></div>

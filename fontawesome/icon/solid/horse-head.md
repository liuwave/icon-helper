...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/horse.html">Horse</router-link></span> <span class="next"><router-link to="/icon/solid/hospital.html">hospital</router-link>→</span></p></div>

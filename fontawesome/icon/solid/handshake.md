...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hands-wash.html">Hands Wash</router-link></span> <span class="next"><router-link to="/icon/regular/handshake.html">Handshake</router-link>→</span></p></div>

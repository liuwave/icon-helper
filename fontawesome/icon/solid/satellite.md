...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/sass.html">Sass</router-link></span> <span class="next"><router-link to="/icon/solid/satellite-dish.html">Satellite Dish</router-link>→</span></p></div>

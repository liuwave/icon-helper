...
<div class="alert alert-dark">
  ...
  <i class="fas fa-comment-alt fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-comment-alt" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-comment-alt"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-comment-alt
    <copy-btn content="fas fa-comment-alt" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Alternate Comment</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate Comment”的评论" />    
<div><p>图标Alternate Comment来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/comment.html">comment</router-link></span> <span class="next"><router-link to="/icon/regular/comment-alt.html">Alternate Comment</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/solid/window-restore.svg
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-window-restore fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-window-restore" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-window-restore"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-window-restore
    <copy-btn content="fas fa-window-restore" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/window-minimize.html">Window Minimize</router-link></span> <span class="next"><router-link to="/icon/regular/window-restore.html">Window Restore</router-link>→</span></p></div>

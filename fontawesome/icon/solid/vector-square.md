...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/vaadin.html">Vaadin</router-link></span> <span class="next"><router-link to="/icon/solid/venus.html">Venus</router-link>→</span></p></div>

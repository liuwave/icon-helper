...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/kickstarter-k.html">Kickstarter K</router-link></span> <span class="next"><router-link to="/icon/regular/kiss.html">Kissing Face</router-link>→</span></p></div>

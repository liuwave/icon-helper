...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/heart.html">Heart</router-link></span> <span class="next"><router-link to="/icon/solid/heartbeat.html">Heartbeat</router-link>→</span></p></div>

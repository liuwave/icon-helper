...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/search-dollar.html">Search Dollar</router-link></span> <span class="next"><router-link to="/icon/solid/search-minus.html">Search Minus</router-link>→</span></p></div>

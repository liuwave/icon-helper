...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sort-amount-down.html">Sort Amount Down</router-link></span> <span class="next"><router-link to="/icon/solid/sort-amount-up.html">Sort Amount Up</router-link>→</span></p></div>

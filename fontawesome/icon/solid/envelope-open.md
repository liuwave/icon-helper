...
image: https://iconhelper.cn/svg/fontawesome/solid/envelope-open.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-envelope-open" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-envelope-open"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-envelope-open
    <copy-btn content="fas fa-envelope-open" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Envelope Open</b>”的评论:</p>
</div>
<Vssue title="关于“Envelope Open”的评论" />    
<div><p>图标Envelope Open来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/envelope.html">Envelope</router-link></span> <span class="next"><router-link to="/icon/regular/envelope-open.html">Envelope Open</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/stripe-s.html">Stripe S</router-link></span> <span class="next"><router-link to="/icon/brands/studiovinari.html">Studio Vinari</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/houzz.html">Houzz</router-link></span> <span class="next"><router-link to="/icon/brands/html5.html">HTML 5 Logo</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/check-double.html">Double Check</router-link></span> <span class="next"><router-link to="/icon/regular/check-square.html">Check Square</router-link>→</span></p></div>

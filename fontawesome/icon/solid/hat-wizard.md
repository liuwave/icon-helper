...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hat-cowboy-side.html">Cowboy Hat Side</router-link></span> <span class="next"><router-link to="/icon/solid/hdd.html">HDD</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/virus-slash.html">Virus Slash</router-link></span> <span class="next"><router-link to="/icon/brands/vk.html">VK</router-link>→</span></p></div>

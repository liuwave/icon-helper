...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/microphone-slash.html">Microphone Slash</router-link></span> <span class="next"><router-link to="/icon/brands/microsoft.html">Microsoft</router-link>→</span></p></div>

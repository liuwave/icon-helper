...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/ruler.html">Ruler</router-link></span> <span class="next"><router-link to="/icon/solid/ruler-horizontal.html">Ruler Horizontal</router-link>→</span></p></div>

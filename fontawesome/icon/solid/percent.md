...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pepper-hot.html">Hot Pepper</router-link></span> <span class="next"><router-link to="/icon/solid/percentage.html">Percentage</router-link>→</span></p></div>

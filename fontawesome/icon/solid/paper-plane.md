...
image: https://iconhelper.cn/svg/fontawesome/solid/paper-plane.svg
...
<div class="alert alert-dark">
  ...
  <i class="fas fa-paper-plane fa-7x"></i>
</div>
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="fas fa-paper-plane" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="fas fa-paper-plane"
    style="font-size: 24px"
    aria-hidden="true"></i> fas fa-paper-plane
    <copy-btn content="fas fa-paper-plane" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Paper Plane</b>”的评论:</p>
</div>
<Vssue title="关于“Paper Plane”的评论" />    
<div><p>图标Paper Plane来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pallet.html">Pallet</router-link></span> <span class="next"><router-link to="/icon/regular/paper-plane.html">Paper Plane</router-link>→</span></p></div>

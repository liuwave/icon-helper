...
image: https://iconhelper.cn/svg/fontawesome/regular/calendar-alt.svg

---

# Alternate Calendar  <small style="font-size: 60%;font-weight: 100">备用日历</small>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-calendar-alt" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-calendar-alt"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-calendar-alt
    <copy-btn content="far fa-calendar-alt" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Alternate Calendar</b>”的评论:</p>
</div>
<Vssue title="关于“Alternate Calendar”的评论" />    
<div><p>图标Alternate Calendar来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/calendar-alt.html">Alternate Calendar</router-link></span> <span class="next"><router-link to="/icon/solid/calendar-check.html">Calendar Check</router-link>→</span></p></div>

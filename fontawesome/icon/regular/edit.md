...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/edit.html">Edit</router-link></span> <span class="next"><router-link to="/icon/solid/egg.html">Egg</router-link>→</span></p></div>

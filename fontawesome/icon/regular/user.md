...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/user.html">User</router-link></span> <span class="next"><router-link to="/icon/solid/user-alt.html">Alternate User</router-link>→</span></p></div>

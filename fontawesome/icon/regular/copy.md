...
image: https://iconhelper.cn/svg/fontawesome/regular/copy.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-copy</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-copy" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-copy"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-copy
    <copy-btn content="far fa-copy" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标Copy来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/copy.html">Copy</router-link></span> <span class="next"><router-link to="/icon/solid/copyright.html">Copyright</router-link>→</span></p></div>

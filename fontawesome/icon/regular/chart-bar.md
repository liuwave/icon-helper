...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/chart-bar.html">Bar Chart</router-link></span> <span class="next"><router-link to="/icon/solid/chart-line.html">Line Chart</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/map.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-map" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-map"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-map
    <copy-btn content="far fa-map" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/map.html">Map</router-link></span> <span class="next"><router-link to="/icon/solid/map-marked.html">Map Marked</router-link>→</span></p></div>

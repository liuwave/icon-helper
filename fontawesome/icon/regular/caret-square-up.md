...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/caret-square-up.html">Caret Square Up</router-link></span> <span class="next"><router-link to="/icon/solid/caret-up.html">Caret Up</router-link>→</span></p></div>

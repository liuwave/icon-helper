...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sad-cry.html">Crying Face</router-link></span> <span class="next"><router-link to="/icon/solid/sad-tear.html">Loudly Crying Face</router-link>→</span></p></div>

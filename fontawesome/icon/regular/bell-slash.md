...
image: https://iconhelper.cn/svg/fontawesome/regular/bell-slash.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/bell-slash.html">Bell Slash</router-link></span> <span class="next"><router-link to="/icon/solid/bezier-curve.html">Bezier Curve</router-link>→</span></p></div>

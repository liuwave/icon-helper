...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/font-awesome-flag.html">Font Awesome Flag</router-link></span> <span class="next"><router-link to="/icon/solid/font-awesome-logo-full.html">Font Awesome Full Logo</router-link>→</span></p></div>

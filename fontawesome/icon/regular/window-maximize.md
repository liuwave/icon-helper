...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/window-maximize.html">Window Maximize</router-link></span> <span class="next"><router-link to="/icon/solid/window-minimize.html">Window Minimize</router-link>→</span></p></div>

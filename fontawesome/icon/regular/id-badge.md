...
image: https://iconhelper.cn/svg/fontawesome/regular/id-badge.svg

---

# Identification Badge  <small style="font-size: 60%;font-weight: 100">标识徽章</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-id-badge</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">f2c1</span> 
<copy-btn content='f2c1' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("f2c1", 16))' btn-title="复制U"></copy-btn>
...
<div class="alert alert-dark">
  <i class="far fa-id-badge fa-xs"></i>
  <i class="far fa-id-badge fa-sm"></i>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="far fa-id-badge" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="far fa-id-badge" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-id-badge"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-id-badge
    <copy-btn content="far fa-id-badge" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-id-badge'></detail>
<div class="icon-detail__container">
<p>关于“<b>Identification Badge</b>”的评论:</p>
</div>
<Vssue title="关于“Identification Badge”的评论" />    
<div><p>图标Identification Badge来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/id-badge.html">Identification Badge</router-link></span> <span class="next"><router-link to="/icon/solid/id-card.html">Identification Card</router-link>→</span></p></div>

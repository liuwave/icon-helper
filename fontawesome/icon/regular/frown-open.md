...
image: https://iconhelper.cn/svg/fontawesome/regular/frown-open.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="far fa-frown-open" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="far fa-frown-open" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-frown-open"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-frown-open
    <copy-btn content="far fa-frown-open" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Frowning Face With Open Mouth</b>”的评论:</p>
</div>
<Vssue title="关于“Frowning Face With Open Mouth”的评论" />    
<div><p>图标Frowning Face With Open Mouth来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/frown-open.html">Frowning Face With Open Mouth</router-link></span> <span class="next"><router-link to="/icon/brands/fulcrum.html">Fulcrum</router-link>→</span></p></div>

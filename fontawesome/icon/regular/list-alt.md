...
image: https://iconhelper.cn/svg/fontawesome/regular/list-alt.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/list-alt.html">Alternate List</router-link></span> <span class="next"><router-link to="/icon/solid/list-ol.html">list-ol</router-link>→</span></p></div>

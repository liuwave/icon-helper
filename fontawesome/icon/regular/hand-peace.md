...
pre: far
search: rest,truce
image: https://iconhelper.cn/svg/fontawesome/regular/hand-peace.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hand-peace.html">Peace (Hand)</router-link></span> <span class="next"><router-link to="/icon/solid/hand-point-down.html">Hand Pointing Down</router-link>→</span></p></div>

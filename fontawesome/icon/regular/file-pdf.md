...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file-pdf.html">PDF File</router-link></span> <span class="next"><router-link to="/icon/solid/file-powerpoint.html">Powerpoint File</router-link>→</span></p></div>

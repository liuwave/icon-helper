...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/thumbs-down.html">thumbs-down</router-link></span> <span class="next"><router-link to="/icon/solid/thumbs-up.html">thumbs-up</router-link>→</span></p></div>

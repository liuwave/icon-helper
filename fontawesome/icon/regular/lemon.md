...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/lemon.html">Lemon</router-link></span> <span class="next"><router-link to="/icon/brands/less.html">Less</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/file.svg

---

# File  <small style="font-size: 60%;font-weight: 100">文件</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-file</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-file" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-file"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-file
    <copy-btn content="far fa-file" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标File来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file.html">File</router-link></span> <span class="next"><router-link to="/icon/solid/file-alt.html">Alternate File</router-link>→</span></p></div>

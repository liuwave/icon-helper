...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/meh-rolling-eyes.html">Face With Rolling Eyes</router-link></span> <span class="next"><router-link to="/icon/solid/memory.html">Memory</router-link>→</span></p></div>

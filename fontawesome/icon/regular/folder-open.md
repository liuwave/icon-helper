...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/folder-open.html">Folder Open</router-link></span> <span class="next"><router-link to="/icon/solid/folder-plus.html">Folder Plus</router-link>→</span></p></div>

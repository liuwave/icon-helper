...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/user-circle.html">User Circle</router-link></span> <span class="next"><router-link to="/icon/solid/user-clock.html">User Clock</router-link>→</span></p></div>

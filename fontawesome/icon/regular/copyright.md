...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/copyright.html">Copyright</router-link></span> <span class="next"><router-link to="/icon/brands/cotton-bureau.html">Cotton Bureau</router-link>→</span></p></div>

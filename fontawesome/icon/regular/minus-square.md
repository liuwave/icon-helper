...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/minus-square.html">Minus Square</router-link></span> <span class="next"><router-link to="/icon/solid/mitten.html">Mitten</router-link>→</span></p></div>

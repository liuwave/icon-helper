...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/registered.html">Registered Trademark</router-link></span> <span class="next"><router-link to="/icon/solid/remove-format.html">Remove Format</router-link>→</span></p></div>

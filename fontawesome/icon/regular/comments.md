...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/comments.html">comments</router-link></span> <span class="next"><router-link to="/icon/solid/comments-dollar.html">Comments Dollar</router-link>→</span></p></div>

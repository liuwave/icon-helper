...
image: https://iconhelper.cn/svg/fontawesome/regular/hospital.svg
...
<div class="alert alert-dark">
  ...
  <i class="far fa-hospital fa-sm"></i>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="far fa-hospital" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="far fa-hospital" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-hospital"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-hospital
    <copy-btn content="far fa-hospital" btn-title="复制图标名称"></copy-btn>
  </div>
</div>

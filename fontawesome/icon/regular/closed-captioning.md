...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/closed-captioning.html">Closed Captioning</router-link></span> <span class="next"><router-link to="/icon/solid/cloud.html">Cloud</router-link>→</span></p></div>

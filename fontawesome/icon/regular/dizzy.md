...
image: https://iconhelper.cn/svg/fontawesome/regular/dizzy.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/dizzy.html">Dizzy Face</router-link></span> <span class="next"><router-link to="/icon/solid/dna.html">DNA</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/kiss-wink-heart.html">Face Blowing a Kiss</router-link></span> <span class="next"><router-link to="/icon/solid/kiwi-bird.html">Kiwi Bird</router-link>→</span></p></div>

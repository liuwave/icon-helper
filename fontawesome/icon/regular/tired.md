...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/tired.html">Tired Face</router-link></span> <span class="next"><router-link to="/icon/solid/toggle-off.html">Toggle Off</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/futbol.html">Futbol</router-link></span> <span class="next"><router-link to="/icon/brands/galactic-republic.html">Galactic Republic</router-link>→</span></p></div>

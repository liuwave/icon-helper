...
image: https://iconhelper.cn/svg/fontawesome/regular/life-ring.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/life-ring.html">Life Ring</router-link></span> <span class="next"><router-link to="/icon/solid/lightbulb.html">Lightbulb</router-link>→</span></p></div>

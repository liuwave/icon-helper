...
image: https://iconhelper.cn/svg/fontawesome/regular/grimace.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/grimace.html">Grimacing Face</router-link></span> <span class="next"><router-link to="/icon/solid/grin.html">Grinning Face</router-link>→</span></p></div>

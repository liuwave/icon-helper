...
image: https://iconhelper.cn/svg/fontawesome/regular/file-image.svg

---

# Image File  <small style="font-size: 60%;font-weight: 100">图像文件</small>
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-file-image" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-file-image"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-file-image
    <copy-btn content="far fa-file-image" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Image File</b>”的评论:</p>
</div>
<Vssue title="关于“Image File”的评论" />    
<div><p>图标Image File来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file-image.html">Image File</router-link></span> <span class="next"><router-link to="/icon/solid/file-import.html">File Import</router-link>→</span></p></div>

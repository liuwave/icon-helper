...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/address-card.html">Address Card</router-link></span> <span class="next"><router-link to="/icon/solid/adjust.html">adjust</router-link>→</span></p></div>

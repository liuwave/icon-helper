...
image: https://iconhelper.cn/svg/fontawesome/regular/eye.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-eye" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-eye"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-eye
    <copy-btn content="far fa-eye" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/eye.html">Eye</router-link></span> <span class="next"><router-link to="/icon/solid/eye-dropper.html">Eye Dropper</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/money-bill-alt.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/money-bill-alt.html">Alternate Money Bill</router-link></span> <span class="next"><router-link to="/icon/solid/money-bill-wave.html">Wavy Money Bill</router-link>→</span></p></div>

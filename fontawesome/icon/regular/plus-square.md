...
image: https://iconhelper.cn/svg/fontawesome/regular/plus-square.svg

---

# Plus Square  <small style="font-size: 60%;font-weight: 100">Plus正方形</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-plus-square</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-plus-square" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-plus-square"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-plus-square
    <copy-btn content="far fa-plus-square" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-plus-square'></detail>
<div class="icon-detail__container">
<p>关于“<b>Plus Square</b>”的评论:</p>
</div>
<Vssue title="关于“Plus Square”的评论" />    
<div><p>图标Plus Square来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/plus-square.html">Plus Square</router-link></span> <span class="next"><router-link to="/icon/solid/podcast.html">Podcast</router-link>→</span></p></div>

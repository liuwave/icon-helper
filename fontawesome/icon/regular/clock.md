...
image: https://iconhelper.cn/svg/fontawesome/regular/clock.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-clock" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-clock"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-clock
    <copy-btn content="far fa-clock" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/clock.html">Clock</router-link></span> <span class="next"><router-link to="/icon/solid/clone.html">Clone</router-link>→</span></p></div>

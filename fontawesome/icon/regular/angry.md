...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/angry.html">Angry Face</router-link></span> <span class="next"><router-link to="/icon/brands/angrycreative.html">Angry Creative</router-link>→</span></p></div>

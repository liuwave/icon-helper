...
image: https://iconhelper.cn/svg/fontawesome/regular/calendar-check.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-calendar-check" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-calendar-check"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-calendar-check
    <copy-btn content="far fa-calendar-check" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/calendar-check.html">Calendar Check</router-link></span> <span class="next"><router-link to="/icon/solid/calendar-day.html">Calendar with Day Focus</router-link>→</span></p></div>

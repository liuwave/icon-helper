...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/grin-squint-tears.html">Rolling on the Floor Laughing</router-link></span> <span class="next"><router-link to="/icon/solid/grin-stars.html">Star-Struck</router-link>→</span></p></div>

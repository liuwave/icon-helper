...
image: https://iconhelper.cn/svg/fontawesome/regular/clipboard.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-clipboard" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-clipboard"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-clipboard
    <copy-btn content="far fa-clipboard" btn-title="复制图标名称"></copy-btn>
  </div>
</div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/smile.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-smile</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-smile" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-smile"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-smile
    <copy-btn content="far fa-smile" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-smile'></detail>
<div class="icon-detail__container">
<p>关于“<b>Smiling Face</b>”的评论:</p>
</div>
<Vssue title="关于“Smiling Face”的评论" />    
<div><p>图标Smiling Face来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/smile.html">Smiling Face</router-link></span> <span class="next"><router-link to="/icon/solid/smile-beam.html">Beaming Face With Smiling Eyes</router-link>→</span></p></div>

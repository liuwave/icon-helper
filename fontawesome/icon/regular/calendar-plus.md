...
image: https://iconhelper.cn/svg/fontawesome/regular/calendar-plus.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/calendar-plus.html">Calendar Plus</router-link></span> <span class="next"><router-link to="/icon/solid/calendar-times.html">Calendar Times</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/id-card.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-id-card" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-id-card"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-id-card
    <copy-btn content="far fa-id-card" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<p>关于“<b>Identification Card</b>”的评论:</p>
</div>
<Vssue title="关于“Identification Card”的评论" />    
<div><p>图标Identification Card来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/id-card.html">Identification Card</router-link></span> <span class="next"><router-link to="/icon/solid/id-card-alt.html">Alternate Identification Card</router-link>→</span></p></div>

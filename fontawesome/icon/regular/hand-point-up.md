...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hand-point-up.html">Hand Pointing Up</router-link></span> <span class="next"><router-link to="/icon/solid/hand-pointer.html">Pointer (Hand)</router-link>→</span></p></div>

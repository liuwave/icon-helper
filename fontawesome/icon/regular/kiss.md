...
image: https://iconhelper.cn/svg/fontawesome/regular/kiss.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/kiss.html">Kissing Face</router-link></span> <span class="next"><router-link to="/icon/solid/kiss-beam.html">Kissing Face With Smiling Eyes</router-link>→</span></p></div>

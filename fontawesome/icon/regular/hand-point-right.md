...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hand-point-right.html">Hand Pointing Right</router-link></span> <span class="next"><router-link to="/icon/solid/hand-point-up.html">Hand Pointing Up</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hand-spock.html">Spock (Hand)</router-link></span> <span class="next"><router-link to="/icon/solid/hands.html">Hands</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/fontawesome/regular/grin-tears.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/grin-tears.html">Face With Tears of Joy</router-link></span> <span class="next"><router-link to="/icon/solid/grin-tongue.html">Face With Tongue</router-link>→</span></p></div>

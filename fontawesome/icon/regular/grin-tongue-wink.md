...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/grin-tongue-wink.html">Winking Face With Tongue</router-link></span> <span class="next"><router-link to="/icon/solid/grin-wink.html">Grinning Winking Face</router-link>→</span></p></div>

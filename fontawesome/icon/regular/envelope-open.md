...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/envelope-open.html">Envelope Open</router-link></span> <span class="next"><router-link to="/icon/solid/envelope-open-text.html">Envelope Open-text</router-link>→</span></p></div>

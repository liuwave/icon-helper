...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/file-code.html">Code File</router-link></span> <span class="next"><router-link to="/icon/solid/file-contract.html">File Contract</router-link>→</span></p></div>

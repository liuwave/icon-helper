...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/laugh.html">Grinning Face With Big Eyes</router-link></span> <span class="next"><router-link to="/icon/solid/laugh-beam.html">Laugh Face with Beaming Eyes</router-link>→</span></p></div>

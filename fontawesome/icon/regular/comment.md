...
image: https://iconhelper.cn/svg/fontawesome/regular/comment.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="far fa-comment" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-comment"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-comment
    <copy-btn content="far fa-comment" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标comment来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

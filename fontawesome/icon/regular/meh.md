...
image: https://iconhelper.cn/svg/fontawesome/regular/meh.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">fa-meh</span> 
</span>
<br/>
<span>
unicode：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="far fa-meh" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="far fa-meh" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="far fa-meh"
    style="font-size: 24px"
    aria-hidden="true"></i> far fa-meh
    <copy-btn content="far fa-meh" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='fa-meh'></detail>
<div class="icon-detail__container">
<p>关于“<b>Neutral Face</b>”的评论:</p>
</div>
<Vssue title="关于“Neutral Face”的评论" />    
<div><p>图标Neutral Face来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/meh.html">Neutral Face</router-link></span> <span class="next"><router-link to="/icon/solid/meh-blank.html">Face Without Mouth</router-link>→</span></p></div>

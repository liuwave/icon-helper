...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/snapchat.html">Snapchat</router-link></span> <span class="next"><router-link to="/icon/brands/snapchat-square.html">Snapchat Square</router-link>→</span></p></div>

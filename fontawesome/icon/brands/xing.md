...
pre: fab
search: 
image: https://iconhelper.cn/svg/fontawesome/brands/xing.svg
...
<div><p>图标Xing来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/xbox.html">Xbox</router-link></span> <span class="next"><router-link to="/icon/brands/xing-square.html">Xing Square</router-link>→</span></p></div>

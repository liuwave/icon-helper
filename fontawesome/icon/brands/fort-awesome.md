...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/football-ball.html">Football Ball</router-link></span> <span class="next"><router-link to="/icon/brands/fort-awesome-alt.html">Alternate Fort Awesome</router-link>→</span></p></div>

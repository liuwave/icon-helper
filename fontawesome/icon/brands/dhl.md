...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/dharmachakra.html">Dharmachakra</router-link></span> <span class="next"><router-link to="/icon/solid/diagnoses.html">Diagnoses</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/reacteurope.html">ReactEurope</router-link></span> <span class="next"><router-link to="/icon/brands/rebel.html">Rebel Alliance</router-link>→</span></p></div>

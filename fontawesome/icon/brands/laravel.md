...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/laptop-medical.html">Laptop Medical</router-link></span> <span class="next"><router-link to="/icon/brands/lastfm.html">last.fm</router-link>→</span></p></div>

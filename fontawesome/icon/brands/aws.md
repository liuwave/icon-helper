...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/award.html">Award</router-link></span> <span class="next"><router-link to="/icon/solid/baby.html">Baby</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/fire-extinguisher.html">fire-extinguisher</router-link></span> <span class="next"><router-link to="/icon/brands/firefox-browser.html">Firefox Browser</router-link>→</span></p></div>

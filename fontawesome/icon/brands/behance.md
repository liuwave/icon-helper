...
pre: fab
search: 
image: https://iconhelper.cn/svg/fontawesome/brands/behance.svg
...
</div><div class="description description alert alert-light">Behance是一个著名设计社区，创意设计人士可以在上面展示自己的作品。</div>
...
<div><p>图标Behance来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/beer.html">beer</router-link></span> <span class="next"><router-link to="/icon/brands/behance-square.html">Behance Square</router-link>→</span></p></div>

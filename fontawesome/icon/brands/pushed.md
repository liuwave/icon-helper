...
pre: fab
search: 
image: https://iconhelper.cn/svg/fontawesome/brands/pushed.svg
...
<p>关于“<b>Pushed</b>”的评论:</p>
</div>
<Vssue title="关于“Pushed”的评论" />    
<div><p>图标Pushed来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/pump-soap.html">Pump Soap</router-link></span> <span class="next"><router-link to="/icon/solid/puzzle-piece.html">Puzzle Piece</router-link>→</span></p></div>

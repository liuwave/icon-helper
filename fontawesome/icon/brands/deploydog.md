...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/democrat.html">Democrat</router-link></span> <span class="next"><router-link to="/icon/brands/deskpro.html">Deskpro</router-link>→</span></p></div>

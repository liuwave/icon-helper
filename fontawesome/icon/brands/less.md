...
pre: fab
search: 
image: https://iconhelper.cn/svg/fontawesome/brands/less.svg
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">更少</span><span class="badge-primary badge">less</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/fontawesome/brands/less.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/fontawesome/brands/less.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light">Less 是一门 CSS 预处理语言,可以运行在 Node 或浏览器端,扩展了 CSS 语言,增加了变量、Mixin、函数等特性。。</div>
...
<Vssue title="关于“Less”的评论" />    
<div><p>图标Less来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/lemon.html">Lemon</router-link></span> <span class="next"><router-link to="/icon/solid/less-than.html">Less Than</router-link>→</span></p></div>

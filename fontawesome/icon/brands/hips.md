...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/hippo.html">Hippo</router-link></span> <span class="next"><router-link to="/icon/brands/hire-a-helper.html">HireAHelper</router-link>→</span></p></div>

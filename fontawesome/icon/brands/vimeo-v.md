...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/vimeo-square.html">Vimeo Square</router-link></span> <span class="next"><router-link to="/icon/brands/vine.html">Vine</router-link>→</span></p></div>

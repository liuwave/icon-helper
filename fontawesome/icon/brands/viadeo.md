...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/viacoin.html">Viacoin</router-link></span> <span class="next"><router-link to="/icon/brands/viadeo-square.html">Video Square</router-link>→</span></p></div>

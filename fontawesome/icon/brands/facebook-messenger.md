...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/facebook-f.html">Facebook F</router-link></span> <span class="next"><router-link to="/icon/brands/facebook-square.html">Facebook Square</router-link>→</span></p></div>

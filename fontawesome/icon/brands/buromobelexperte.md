...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/burn.html">Burn</router-link></span> <span class="next"><router-link to="/icon/solid/bus.html">Bus</router-link>→</span></p></div>

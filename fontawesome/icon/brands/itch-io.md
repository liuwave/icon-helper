...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/italic.html">italic</router-link></span> <span class="next"><router-link to="/icon/brands/itunes.html">iTunes</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/reply-all.html">reply-all</router-link></span> <span class="next"><router-link to="/icon/solid/republican.html">Republican</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/linkedin-in.html">LinkedIn In</router-link></span> <span class="next"><router-link to="/icon/brands/linux.html">Linux</router-link>→</span></p></div>

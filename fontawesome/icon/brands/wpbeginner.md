...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/wordpress-simple.html">Wordpress Simple</router-link></span> <span class="next"><router-link to="/icon/brands/wpexplorer.html">WPExplorer</router-link>→</span></p></div>

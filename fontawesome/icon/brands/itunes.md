...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/itch-io.html">itch.io</router-link></span> <span class="next"><router-link to="/icon/brands/itunes-note.html">Itunes Note</router-link>→</span></p></div>

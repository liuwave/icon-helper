...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/medal.html">Medal</router-link></span> <span class="next"><router-link to="/icon/brands/medium.html">Medium</router-link>→</span></p></div>

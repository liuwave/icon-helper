...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/mail-bulk.html">Mail Bulk</router-link></span> <span class="next"><router-link to="/icon/solid/male.html">Male</router-link>→</span></p></div>

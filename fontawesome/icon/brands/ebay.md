...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/earlybirds.html">Earlybirds</router-link></span> <span class="next"><router-link to="/icon/brands/edge.html">Edge Browser</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/battery-three-quarters.html">Battery 3/4 Full</router-link></span> <span class="next"><router-link to="/icon/solid/bed.html">Bed</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/sitemap.html">Sitemap</router-link></span> <span class="next"><router-link to="/icon/solid/skating.html">Skating</router-link>→</span></p></div>

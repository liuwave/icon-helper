...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/allergies.html">Allergies</router-link></span> <span class="next"><router-link to="/icon/brands/amazon-pay.html">Amazon Pay</router-link>→</span></p></div>

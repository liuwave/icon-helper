...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/globe-europe.html">Globe with Europe shown</router-link></span> <span class="next"><router-link to="/icon/solid/golf-ball.html">Golf Ball</router-link>→</span></p></div>

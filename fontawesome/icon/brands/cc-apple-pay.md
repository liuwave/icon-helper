...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/cc-amex.html">American Express Credit Card</router-link></span> <span class="next"><router-link to="/icon/brands/cc-diners-club.html">Diner's Club Credit Card</router-link>→</span></p></div>

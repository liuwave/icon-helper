...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/joint.html">Joint</router-link></span> <span class="next"><router-link to="/icon/solid/journal-whills.html">Journal of the Whills</router-link>→</span></p></div>

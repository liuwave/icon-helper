...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/space-shuttle.html">Space Shuttle</router-link></span> <span class="next"><router-link to="/icon/brands/speaker-deck.html">Speaker Deck</router-link>→</span></p></div>

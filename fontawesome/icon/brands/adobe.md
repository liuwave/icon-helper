...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/adn.html">App.net</router-link></span> <span class="next"><router-link to="/icon/brands/adversal.html">Adversal</router-link>→</span></p></div>

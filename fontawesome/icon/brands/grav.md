...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/gratipay.html">Gratipay (Gittip)</router-link></span> <span class="next"><router-link to="/icon/solid/greater-than.html">Greater Than</router-link>→</span></p></div>

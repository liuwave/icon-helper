...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/font-awesome-logo-full.html">Font Awesome Full Logo</router-link></span> <span class="next"><router-link to="/icon/brands/fonticons.html">Fonticons</router-link>→</span></p></div>

...
pre: fab
search: leaf
image: https://iconhelper.cn/svg/fontawesome/brands/envira.svg
...
<br/>
<span>别名：<span class="badge-light badge">leaf</span></span><br/><span class="zh-detail">中文描述：<span class="badge-primary badge">环境画廊</span><span class="badge-primary badge">叶</span><span class="badge-primary badge">叶子</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/fontawesome/brands/envira.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/fontawesome/brands/envira.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<p>关于“<b>Envira Gallery</b>”的评论:</p>
</div>
<Vssue title="关于“Envira Gallery”的评论" />    
<div><p>图标Envira Gallery来源于Fontawesome Icon Free，可免费使用，更多关于  Fontawesome Icon Free的信息，参见：<a target="_blank" href="https://iconhelper.cn/fontawesome.html">Fontawesome Icon Free</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/envelope-square.html">Envelope Square</router-link></span> <span class="next"><router-link to="/icon/solid/equals.html">Equals</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/id-card-alt.html">Alternate Identification Card</router-link></span> <span class="next"><router-link to="/icon/solid/igloo.html">Igloo</router-link>→</span></p></div>

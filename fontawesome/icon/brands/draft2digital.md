...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/download.html">Download</router-link></span> <span class="next"><router-link to="/icon/solid/drafting-compass.html">Drafting Compass</router-link>→</span></p></div>

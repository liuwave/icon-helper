...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/usps.html">United States Postal Service</router-link></span> <span class="next"><router-link to="/icon/solid/utensil-spoon.html">Utensil Spoon</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/connectdevelop.html">Connect Develop</router-link></span> <span class="next"><router-link to="/icon/solid/cookie.html">Cookie</router-link>→</span></p></div>

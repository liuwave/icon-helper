...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/cloud-upload-alt.html">Alternate Cloud Upload</router-link></span> <span class="next"><router-link to="/icon/brands/cloudsmith.html">Cloudsmith</router-link>→</span></p></div>

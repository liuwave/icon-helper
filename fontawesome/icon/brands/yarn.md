...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/yandex-international.html">Yandex International</router-link></span> <span class="next"><router-link to="/icon/brands/yelp.html">Yelp</router-link>→</span></p></div>

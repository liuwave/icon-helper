...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/ns8.html">NS8</router-link></span> <span class="next"><router-link to="/icon/solid/object-group.html">Object Group</router-link>→</span></p></div>

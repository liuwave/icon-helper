...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/cc-jcb.html">JCB Credit Card</router-link></span> <span class="next"><router-link to="/icon/brands/cc-paypal.html">Paypal Credit Card</router-link>→</span></p></div>

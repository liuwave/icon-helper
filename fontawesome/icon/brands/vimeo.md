...
pre: fab
search: 
image: https://iconhelper.cn/svg/fontawesome/brands/vimeo.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/vihara.html">Vihara</router-link></span> <span class="next"><router-link to="/icon/brands/vimeo-square.html">Vimeo Square</router-link>→</span></p></div>

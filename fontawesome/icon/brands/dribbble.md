...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/draw-polygon.html">Draw Polygon</router-link></span> <span class="next"><router-link to="/icon/brands/dribbble-square.html">Dribbble Square</router-link>→</span></p></div>

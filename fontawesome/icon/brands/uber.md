...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/typo3.html">Typo3</router-link></span> <span class="next"><router-link to="/icon/brands/ubuntu.html">Ubuntu</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/taxi.html">Taxi</router-link></span> <span class="next"><router-link to="/icon/solid/teeth.html">Teeth</router-link>→</span></p></div>

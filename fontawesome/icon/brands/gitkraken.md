...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/github-square.html">GitHub Square</router-link></span> <span class="next"><router-link to="/icon/brands/gitlab.html">GitLab</router-link>→</span></p></div>

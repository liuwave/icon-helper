...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/brush.html">Brush</router-link></span> <span class="next"><router-link to="/icon/brands/buffer.html">Buffer</router-link>→</span></p></div>

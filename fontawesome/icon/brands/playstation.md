...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/regular/play-circle.html">Play Circle</router-link></span> <span class="next"><router-link to="/icon/solid/plug.html">Plug</router-link>→</span></p></div>

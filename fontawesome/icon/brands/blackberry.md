...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/black-tie.html">Font Awesome Black Tie</router-link></span> <span class="next"><router-link to="/icon/solid/blender.html">Blender</router-link>→</span></p></div>

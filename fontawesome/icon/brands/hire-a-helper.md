...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/hips.html">Hips</router-link></span> <span class="next"><router-link to="/icon/solid/history.html">History</router-link>→</span></p></div>

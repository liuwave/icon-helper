...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/foursquare.html">Foursquare</router-link></span> <span class="next"><router-link to="/icon/brands/freebsd.html">FreeBSD</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/gripfire.html">Gripfire, Inc.</router-link></span> <span class="next"><router-link to="/icon/solid/guitar.html">Guitar</router-link>→</span></p></div>

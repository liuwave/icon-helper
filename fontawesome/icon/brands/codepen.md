...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solid/code-branch.html">Code Branch</router-link></span> <span class="next"><router-link to="/icon/brands/codiepie.html">Codie Pie</router-link>→</span></p></div>

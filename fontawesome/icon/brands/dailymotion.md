...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/d-and-d-beyond.html">D&D Beyond</router-link></span> <span class="next"><router-link to="/icon/brands/dashcube.html">DashCube</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brands/first-order.html">First Order</router-link></span> <span class="next"><router-link to="/icon/brands/firstdraft.html">firstdraft</router-link>→</span></p></div>

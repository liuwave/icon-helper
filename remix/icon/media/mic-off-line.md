...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/media/mic-off-fill.html">mic off fill</router-link></span> <span class="next"><router-link to="/icon/media/volume-down-fill.html">volume down fill</router-link>→</span></p></div>

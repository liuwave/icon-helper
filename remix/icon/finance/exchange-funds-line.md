...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/finance/exchange-funds-fill.html">exchange funds fill</router-link></span> <span class="next"><router-link to="/icon/finance/increase-decrease-fill.html">increase decrease fill</router-link>→</span></p></div>

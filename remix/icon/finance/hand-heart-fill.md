...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/finance/hand-coin-line.html">hand coin line</router-link></span> <span class="next"><router-link to="/icon/finance/hand-heart-line.html">hand heart line</router-link>→</span></p></div>

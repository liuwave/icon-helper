...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/buildings/hospital-line.html">hospital line</router-link></span> <span class="next"><router-link to="/icon/buildings/ancient-gate-line.html">ancient gate line</router-link>→</span></p></div>

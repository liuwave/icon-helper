...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/others/knife-fill.html">knife fill</router-link></span> <span class="next"><router-link to="/icon/others/knife-blood-fill.html">knife blood fill</router-link>→</span></p></div>

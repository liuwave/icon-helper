...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/others/hearts-fill.html">hearts fill</router-link></span> <span class="next"><router-link to="/icon/others/key-fill.html">key fill</router-link>→</span></p></div>

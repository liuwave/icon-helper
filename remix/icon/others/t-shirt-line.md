...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/others/t-shirt-fill.html">t shirt fill</router-link></span> <span class="next"><router-link to="/icon/others/t-shirt-2-fill.html">t shirt 2 fill</router-link>→</span></p></div>

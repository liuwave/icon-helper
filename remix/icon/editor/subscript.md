...
tags: ["editor"]
search: 
image: https://iconhelper.cn/svg/remix/editor/subscript.svg

---

# subscript  <small style="font-size: 60%;font-weight: 100">角标</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">ri-subscript</span> 
</span>
<br/>
<span>
unicode：
...
<div class="alert alert-dark">
  ...
  <i class="ri-subscript ri-lg"></i>
  <i class="ri-subscript ri-2x"></i>
  <i class="ri-subscript ri-3x"></i>
  <i class="ri-subscript ri-5x"></i>
  <i class="ri-subscript ri-7x"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="ri-subscript" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="ri-subscript" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="ri-subscript"
    style="font-size: 24px"
    aria-hidden="true"></i> ri-subscript
    <copy-btn content="ri-subscript" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='ri-subscript'></detail>  
<div class="icon-detail__container">
<p>关于“<b>subscript</b>”的评论:</p>
</div>
<Vssue title="关于“subscript”的评论" />    
<div><p>图标subscript来源于 Remix Icon，可免费使用，更多关于  Remix Icon的信息，参见：<a target="_blank" href="https://iconhelper.cn/remix.html">Remix Icon</a>
</p></div>

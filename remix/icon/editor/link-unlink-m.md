...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/editor/link-m.html">link m</router-link></span> <span class="next"><router-link to="/icon/editor/separator.html">separator</router-link>→</span></p></div>

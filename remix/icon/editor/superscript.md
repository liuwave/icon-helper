...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/editor/subscript-2.html">subscript 2</router-link></span> <span class="next"><router-link to="/icon/editor/superscript-2.html">superscript 2</router-link>→</span></p></div>

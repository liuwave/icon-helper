...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/editor/translate-2.html">translate 2</router-link></span> <span class="next"><router-link to="/icon/editor/english-input.html">english input</router-link>→</span></p></div>

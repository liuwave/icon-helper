...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/user-faces/skull-line.html">skull line</router-link></span> <span class="next"><router-link to="/icon/user-faces/skull-2-line.html">skull 2 line</router-link>→</span></p></div>

...
tags: ["user-faces"]
search: horror,line
image: https://iconhelper.cn/svg/remix/user-faces/ghost-2-line.svg
...
<p>关于“<b>ghost 2 line</b>”的评论:</p>
</div>
<Vssue title="关于“ghost 2 line”的评论" />    
<div><p>图标ghost 2 line来源于 Remix Icon，可免费使用，更多关于  Remix Icon的信息，参见：<a target="_blank" href="https://iconhelper.cn/remix.html">Remix Icon</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/user-faces/ghost-2-fill.html">ghost 2 fill</router-link></span> <span class="next"><router-link to="/icon/user-faces/ghost-smile-fill.html">ghost smile fill</router-link>→</span></p></div>

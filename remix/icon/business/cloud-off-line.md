...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/business/cloud-off-fill.html">cloud off fill</router-link></span> <span class="next"><router-link to="/icon/business/attachment-fill.html">attachment fill</router-link>→</span></p></div>

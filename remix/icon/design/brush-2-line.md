...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/design/brush-2-fill.html">brush 2 fill</router-link></span> <span class="next"><router-link to="/icon/design/brush-3-fill.html">brush 3 fill</router-link>→</span></p></div>

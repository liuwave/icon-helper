...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/design/paint-line.html">paint line</router-link></span> <span class="next"><router-link to="/icon/design/palette-line.html">palette line</router-link>→</span></p></div>

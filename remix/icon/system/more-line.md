...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/system/more-fill.html">more fill</router-link></span> <span class="next"><router-link to="/icon/system/more-2-fill.html">more 2 fill</router-link>→</span></p></div>

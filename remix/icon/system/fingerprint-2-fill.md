...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/system/fingerprint-line.html">fingerprint line</router-link></span> <span class="next"><router-link to="/icon/system/fingerprint-2-line.html">fingerprint 2 line</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/system/settings-4-fill.html">settings 4 fill</router-link></span> <span class="next"><router-link to="/icon/system/settings-5-fill.html">settings 5 fill</router-link>→</span></p></div>

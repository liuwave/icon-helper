...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/wechat-fill.html">wechat fill</router-link></span> <span class="next"><router-link to="/icon/logos/wechat-2-fill.html">wechat 2 fill</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/invision-fill.html">invision fill</router-link></span> <span class="next"><router-link to="/icon/logos/zcool-fill.html">zcool fill</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/playstation-fill.html">playstation fill</router-link></span> <span class="next"><router-link to="/icon/logos/switch-fill.html">switch fill</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/switch-line.html">switch line</router-link></span> <span class="next"><router-link to="/icon/logos/xbox-line.html">xbox line</router-link>→</span></p></div>

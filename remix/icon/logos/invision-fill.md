...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/pinterest-line.html">pinterest line</router-link></span> <span class="next"><router-link to="/icon/logos/invision-line.html">invision line</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/xing-line.html">xing line</router-link></span> <span class="next"><router-link to="/icon/logos/app-store-line.html">app store line</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/apple-fill.html">apple fill</router-link></span> <span class="next"><router-link to="/icon/logos/google-fill.html">google fill</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/logos/reactjs-fill.html">reactjs fill</router-link></span> <span class="next"><router-link to="/icon/logos/vuejs-fill.html">vuejs fill</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/zapier.html">Zapier</router-link></span> <span class="next"><router-link to="/icon/zeit.html">Zeit</router-link>→</span></p></div>

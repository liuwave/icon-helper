...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/raspberry-pi.html">Raspberry Pi</router-link></span> <span class="next"><router-link to="/icon/react-router.html">React Router</router-link>→</span></p></div>

...
title: WebRTC(网页即时通信) ICON转svg、png下载
name: webrtc
zhTips: 网页即时通信
search: 
...
# WebRTC  <small style="font-size: 60%;font-weight: 100">网页即时通信</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">网页即时通信</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/webrtc.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/webrtc.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light"><p>webrtc是一个支持网页浏览器进行实时语音对话或视频对话的API。</p><p>图标来源地址：<a href="https://webrtc.org/press/" target="_blank" rel="noopener noreferrer">https://webrtc.org/press/</a></p></div>

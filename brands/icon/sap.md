...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/samsung-pay.html">Samsung Pay</router-link></span> <span class="next"><router-link to="/icon/sass.html">Sass</router-link>→</span></p></div>

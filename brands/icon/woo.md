...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wolfram-mathematica.html">Wolfram Mathematica</router-link></span> <span class="next"><router-link to="/icon/woocommerce.html">WooCommerce</router-link>→</span></p></div>

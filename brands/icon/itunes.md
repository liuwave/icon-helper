...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/itch-io.html">Itch.io</router-link></span> <span class="next"><router-link to="/icon/iveco.html">IVECO</router-link>→</span></p></div>

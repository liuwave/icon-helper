...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/amd.html">AMD</router-link></span> <span class="next"><router-link to="/icon/american-express.html">American Express</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/adguard.html">AdGuard</router-link></span> <span class="next"><router-link to="/icon/adobe-acrobat-reader.html">Adobe Acrobat Reader</router-link>→</span></p></div>

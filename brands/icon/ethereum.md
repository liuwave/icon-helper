...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/eslint.html">ESLint</router-link></span> <span class="next"><router-link to="/icon/etsy.html">Etsy</router-link>→</span></p></div>

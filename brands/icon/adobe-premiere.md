...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/adobe-photoshop.html">Adobe Photoshop</router-link></span> <span class="next"><router-link to="/icon/adobe-typekit.html">Adobe Typekit</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/actigraph.html">ActiGraph</router-link></span> <span class="next"><router-link to="/icon/adblock.html">AdBlock</router-link>→</span></p></div>

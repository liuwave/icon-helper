...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/analogue.html">Analogue</router-link></span> <span class="next"><router-link to="/icon/andela.html">Andela</router-link>→</span></p></div>

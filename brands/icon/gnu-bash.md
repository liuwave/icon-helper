...
title: GNU Bash(GNU Bash) ICON转svg、png下载
name: gnu-bash
zhTips: GNU Bash
search: 
...
# GNU Bash  <small style="font-size: 60%;font-weight: 100">GNU Bash</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">GNU Bash</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/gnu-bash.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/gnu-bash.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gnu.html">GNU</router-link></span> <span class="next"><router-link to="/icon/gnu-emacs.html">GNU Emacs</router-link>→</span></p></div>

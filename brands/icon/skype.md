...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/skyliner.html">Skyliner</router-link></span> <span class="next"><router-link to="/icon/skype-for-business.html">Skype for Business</router-link>→</span></p></div>

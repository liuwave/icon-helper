...
title: Khan Academy(汗学院) ICON转svg、png下载
name: khan-academy
zhTips: 汗学院
search: 
...
# Khan Academy  <small style="font-size: 60%;font-weight: 100">汗学院</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">汗学院</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/khan-academy.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/khan-academy.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<p>关于“<b>Khan Academy</b>”的评论:</p>
</div>
<Vssue title="关于“Khan Academy”的评论" />
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/keycdn.html">KeyCDN</router-link></span> <span class="next"><router-link to="/icon/khronos-group.html">Khronos Group</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/houdini.html">Houdini</router-link></span> <span class="next"><router-link to="/icon/hp.html">HP</router-link>→</span></p></div>

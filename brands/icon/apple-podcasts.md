...
title: Apple Podcasts(Apple播客) ICON转svg、png下载
name: apple-podcasts
zhTips: Apple播客
search: 
...
# Apple Podcasts  <small style="font-size: 60%;font-weight: 100">Apple播客</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">Apple播客</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/apple-podcasts.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/apple-podcasts.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<p>关于“<b>Apple Podcasts</b>”的评论:</p>
</div>
<Vssue title="关于“Apple Podcasts”的评论" />
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/apple-pay.html">Apple Pay</router-link></span> <span class="next"><router-link to="/icon/apple-tv.html">Apple TV</router-link>→</span></p></div>

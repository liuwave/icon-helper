...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/mojang.html">Mojang</router-link></span> <span class="next"><router-link to="/icon/mongodb.html">MongoDB</router-link>→</span></p></div>

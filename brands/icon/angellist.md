...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/android-studio.html">Android Studio</router-link></span> <span class="next"><router-link to="/icon/angular.html">Angular</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/try-it-online.html">Try It Online</router-link></span> <span class="next"><router-link to="/icon/turkish-airlines.html">Turkish Airlines</router-link>→</span></p></div>

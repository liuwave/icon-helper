...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/yelp.html">Yelp</router-link></span> <span class="next"><router-link to="/icon/youtube-gaming.html">YouTube Gaming</router-link>→</span></p></div>

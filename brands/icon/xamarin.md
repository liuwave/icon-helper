...
title: Xamarin(跨平台的开发平台) ICON转svg、png下载
name: xamarin
zhTips: 跨平台的开发平台
search: .NET
...
# Xamarin  <small style="font-size: 60%;font-weight: 100">跨平台的开发平台</small>
...
<br/>
<span>别名：<span class="badge-light badge">.NET</span></span><br/><span class="zh-detail">中文描述：<span class="badge-primary badge">跨平台的开发平台</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/xamarin.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/xamarin.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light"><p>Xamarin是一个开放源码的移动平台，允许开发人员为IOS、Android、tvOS、Watch和MacOS开发跨平台应用程序。</p><p>图标来源地址：<a href="https://github.com/dotnet/swag/tree/master/xamarin" target="_blank" rel="noopener noreferrer">https://github.com/dotnet/swag/tree/master/xamarin</a></p></div>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/x-org.html">X.Org</router-link></span> <span class="next"><router-link to="/icon/xaml.html">XAML</router-link>→</span></p></div>

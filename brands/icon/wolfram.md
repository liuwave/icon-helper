...
title: Wolfram(沃尔夫拉姆研究公司) ICON转svg、png下载
name: wolfram
zhTips: 沃尔夫拉姆研究公司
search: 
...
# Wolfram  <small style="font-size: 60%;font-weight: 100">沃尔夫拉姆研究公司</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">沃尔夫拉姆研究公司</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/wolfram.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/wolfram.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light"><p>Wolfram Research是由斯蒂芬·沃尔夫拉姆于1987年创建，是美国的一家计算机、网络和云软件公司。</p><p>图标来源地址：<a href="http://company.wolfram.com/press-center/wolfram-corporate/" target="_blank" rel="noopener noreferrer">http://company.wolfram.com/press-center/wolfram-corporate/</a></p></div>
...
<p>关于“<b>Wolfram</b>”的评论:</p>
</div>
<Vssue title="关于“Wolfram”的评论" />
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wizz-air.html">Wizz Air</router-link></span> <span class="next"><router-link to="/icon/wolfram-language.html">Wolfram Language</router-link>→</span></p></div>

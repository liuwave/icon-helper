...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fossil-scm.html">Fossil SCM</router-link></span> <span class="next"><router-link to="/icon/framer.html">Framer</router-link>→</span></p></div>

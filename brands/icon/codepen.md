...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/codeigniter.html">CodeIgniter</router-link></span> <span class="next"><router-link to="/icon/coderwall.html">Coderwall</router-link>→</span></p></div>

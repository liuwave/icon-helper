...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/mastercard.html">MasterCard</router-link></span> <span class="next"><router-link to="/icon/material-design.html">Material Design</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sentry.html">Sentry</router-link></span> <span class="next"><router-link to="/icon/serverless.html">Serverless</router-link>→</span></p></div>

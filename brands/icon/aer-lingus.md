...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/adonisjs.html">AdonisJS</router-link></span> <span class="next"><router-link to="/icon/affinity.html">Affinity</router-link>→</span></p></div>

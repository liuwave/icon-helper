...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sprint.html">Sprint</router-link></span> <span class="next"><router-link to="/icon/square-enix.html">Square Enix</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/macy-s.html">Macy’s</router-link></span> <span class="next"><router-link to="/icon/magisk.html">Magisk</router-link>→</span></p></div>

...
title: WebAssembly(Web程序集) ICON转svg、png下载
name: webassembly
zhTips: WebAssembly,Web程序集
search: 
image: https://iconhelper.cn/svg/brands/webassembly.svg

---

# WebAssembly  <small style="font-size: 60%;font-weight: 100">Web程序集</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">WebAssembly</span><span class="badge-primary badge">Web程序集</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/webassembly.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/webassembly.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light"><p>WebAssembly 是由主流浏览器厂商组成的W3C制定的一个新的编码方式，可以让以各种语言编写的代码都可以原生速度在Web中运行。</p><p>图标来源地址：<a href="https://webassembly.org/" target="_blank" rel="noopener noreferrer">https://webassembly.org/</a></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/flickr.html">Flickr</router-link></span> <span class="next"><router-link to="/icon/floatplane.html">Floatplane</router-link>→</span></p></div>

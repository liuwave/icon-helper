...
title: Crunchyroll(Crunchyroll) ICON转svg、png下载
name: crunchyroll
zhTips: Crunchyroll
search: 
...
# Crunchyroll  <small style="font-size: 60%;font-weight: 100">Crunchyroll</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">Crunchyroll</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/crunchyroll.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/crunchyroll.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<p>关于“<b>Crunchyroll</b>”的评论:</p>
</div>
<Vssue title="关于“Crunchyroll”的评论" />
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/crunchbase.html">Crunchbase</router-link></span> <span class="next"><router-link to="/icon/cryengine.html">CRYENGINE</router-link>→</span></p></div>

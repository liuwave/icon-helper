...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/opengl.html">OpenGL</router-link></span> <span class="next"><router-link to="/icon/openssl.html">OpenSSL</router-link>→</span></p></div>

...
zhTips: SoundCloud
search: 
image: https://iconhelper.cn/svg/brands/soundcloud.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sonos.html">Sonos</router-link></span> <span class="next"><router-link to="/icon/source-engine.html">Source Engine</router-link>→</span></p></div>

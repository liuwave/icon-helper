...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/react.html">React</router-link></span> <span class="next"><router-link to="/icon/reactos.html">ReactOS</router-link>→</span></p></div>

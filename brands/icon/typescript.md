...
title: TypeScript(TypeScript) ICON转svg、png下载
name: typescript
zhTips: TypeScript
search: 
...
# TypeScript  <small style="font-size: 60%;font-weight: 100">TypeScript</small>
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">TypeScript</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/brands/typescript.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/brands/typescript.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/twoo.html">Twoo</router-link></span> <span class="next"><router-link to="/icon/typo3.html">TYPO3</router-link>→</span></p></div>

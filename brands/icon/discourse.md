...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/discord.html">Discord</router-link></span> <span class="next"><router-link to="/icon/discover.html">Discover</router-link>→</span></p></div>

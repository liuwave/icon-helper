...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/subway-alert-variant.html">subway-alert-variant</router-link></span> <span class="next"><router-link to="/icon/summit.html">summit</router-link>→</span></p></div>

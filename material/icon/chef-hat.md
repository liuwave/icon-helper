...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cheese-off.html">cheese-off</router-link></span> <span class="next"><router-link to="/icon/chemical-weapon.html">chemical-weapon</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/clock-end.html">clock-end</router-link></span> <span class="next"><router-link to="/icon/clock-in.html">clock-in</router-link>→</span></p></div>

...
tags: []
search: weight-kg
image: https://iconhelper.cn/svg/material/weight-kilogram.svg
...
<copy-btn content='F05A2' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F05A2", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>weight kilogram</b>”的评论:</p>
</div>
<Vssue title="关于“weight kilogram”的评论" />    
<div><p>图标weight kilogram来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/weight-gram.html">weight-gram</router-link></span> <span class="next"><router-link to="/icon/weight-lifter.html">weight-lifter</router-link>→</span></p></div>

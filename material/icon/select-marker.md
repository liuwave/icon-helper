...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/select-inverse.html">select-inverse</router-link></span> <span class="next"><router-link to="/icon/select-multiple.html">select-multiple</router-link>→</span></p></div>

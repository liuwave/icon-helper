...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/passport.html">passport</router-link></span> <span class="next"><router-link to="/icon/pasta.html">pasta</router-link>→</span></p></div>

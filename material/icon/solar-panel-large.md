...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/solar-panel.html">solar-panel</router-link></span> <span class="next"><router-link to="/icon/solar-power.html">solar-power</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/axis-arrow.html">axis-arrow</router-link></span> <span class="next"><router-link to="/icon/axis-lock.html">axis-lock</router-link>→</span></p></div>

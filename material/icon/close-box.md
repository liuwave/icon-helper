...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/close.html">close</router-link></span> <span class="next"><router-link to="/icon/close-box-multiple.html">close-box-multiple</router-link>→</span></p></div>

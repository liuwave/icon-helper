...
tags: []
search: cc
image: https://iconhelper.cn/svg/material/closed-caption.svg
...
<p>关于“<b>closed caption</b>”的评论:</p>
</div>
<Vssue title="关于“closed caption”的评论" />    
<div><p>图标closed caption来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/close-thick.html">close-thick</router-link></span> <span class="next"><router-link to="/icon/closed-caption-outline.html">closed-caption-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cog-off.html">cog-off</router-link></span> <span class="next"><router-link to="/icon/cog-outline.html">cog-outline</router-link>→</span></p></div>

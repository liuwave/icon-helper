...
tags: ["date-time"]
search: event-star
image: https://iconhelper.cn/svg/material/calendar-star.svg
...
<p>关于“<b>calendar star</b>”的评论:</p>
</div>
<Vssue title="关于“calendar star”的评论" />    
<div><p>图标calendar star来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/calendar-search.html">calendar-search</router-link></span> <span class="next"><router-link to="/icon/calendar-sync.html">calendar-sync</router-link>→</span></p></div>

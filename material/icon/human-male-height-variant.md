...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/human-male-height.html">human-male-height</router-link></span> <span class="next"><router-link to="/icon/human-male-male.html">human-male-male</router-link>→</span></p></div>

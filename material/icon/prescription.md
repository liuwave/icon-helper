...
search: 
image: https://iconhelper.cn/svg/material/prescription.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/powershell.html">powershell</router-link></span> <span class="next"><router-link to="/icon/presentation.html">presentation</router-link>→</span></p></div>

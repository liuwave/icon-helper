...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/safe.html">safe</router-link></span> <span class="next"><router-link to="/icon/safe-square-outline.html">safe-square-outline</router-link>→</span></p></div>

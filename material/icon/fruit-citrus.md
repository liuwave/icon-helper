...
image: https://iconhelper.cn/svg/material/fruit-citrus.svg
...
<p>关于“<b>fruit citrus</b>”的评论:</p>
</div>
<Vssue title="关于“fruit citrus”的评论" />    
<div><p>图标fruit citrus来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fruit-cherries-off.html">fruit-cherries-off</router-link></span> <span class="next"><router-link to="/icon/fruit-citrus-off.html">fruit-citrus-off</router-link>→</span></p></div>

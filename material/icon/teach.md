...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tea-outline.html">tea-outline</router-link></span> <span class="next"><router-link to="/icon/teamviewer.html">teamviewer</router-link>→</span></p></div>

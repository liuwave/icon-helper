...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/kettle-steam.html">kettle-steam</router-link></span> <span class="next"><router-link to="/icon/kettlebell.html">kettlebell</router-link>→</span></p></div>

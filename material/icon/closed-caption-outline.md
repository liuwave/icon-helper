...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/closed-caption.html">closed-caption</router-link></span> <span class="next"><router-link to="/icon/cloud.html">cloud</router-link>→</span></p></div>

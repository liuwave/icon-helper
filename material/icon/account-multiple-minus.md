...
image: https://iconhelper.cn/svg/material/account-multiple-minus.svg
...
<copy-btn content='F05D3' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F05D3", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>account multiple minus</b>”的评论:</p>
</div>
<Vssue title="关于“account multiple minus”的评论" />    
<div><p>图标account multiple minus来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-multiple-check-outline.html">account-multiple-check-outline</router-link></span> <span class="next"><router-link to="/icon/account-multiple-minus-outline.html">account-multiple-minus-outline</router-link>→</span></p></div>

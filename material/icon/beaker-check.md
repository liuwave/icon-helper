...
tags: ["science"]
search: 
image: https://iconhelper.cn/svg/material/beaker-check.svg
...
<p>关于“<b>beaker check</b>”的评论:</p>
</div>
<Vssue title="关于“beaker check”的评论" />    
<div><p>图标beaker check来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/beaker-alert-outline.html">beaker-alert-outline</router-link></span> <span class="next"><router-link to="/icon/beaker-check-outline.html">beaker-check-outline</router-link>→</span></p></div>

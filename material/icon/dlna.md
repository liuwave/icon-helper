...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/division-box.html">division-box</router-link></span> <span class="next"><router-link to="/icon/dna.html">dna</router-link>→</span></p></div>

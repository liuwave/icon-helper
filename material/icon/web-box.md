...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/web.html">web</router-link></span> <span class="next"><router-link to="/icon/web-clock.html">web-clock</router-link>→</span></p></div>

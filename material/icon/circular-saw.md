...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/circle-small.html">circle-small</router-link></span> <span class="next"><router-link to="/icon/city.html">city</router-link>→</span></p></div>

...
tags: ["files-folders"]
search: 
image: https://iconhelper.cn/svg/material/file-percent-outline.svg
...
<copy-btn content='F1033' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F1033", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>file percent outline</b>”的评论:</p>
</div>
<Vssue title="关于“file percent outline”的评论" />    
<div><p>图标file percent outline来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/file-percent.html">file-percent</router-link></span> <span class="next"><router-link to="/icon/file-phone.html">file-phone</router-link>→</span></p></div>

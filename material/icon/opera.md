...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/openid.html">openid</router-link></span> <span class="next"><router-link to="/icon/orbit.html">orbit</router-link>→</span></p></div>

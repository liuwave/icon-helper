...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/link-box-variant-outline.html">link-box-variant-outline</router-link></span> <span class="next"><router-link to="/icon/link-off.html">link-off</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/material/alert-octagram-outline.svg
...
<copy-btn content='F0CE7' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0CE7", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>alert octagram outline</b>”的评论:</p>
</div>
<Vssue title="关于“alert octagram outline”的评论" />    
<div><p>图标alert octagram outline来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

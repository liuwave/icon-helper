...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/zodiac-gemini.html">zodiac-gemini</router-link></span> <span class="next"><router-link to="/icon/zodiac-libra.html">zodiac-libra</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/credit-card-marker.html">credit-card-marker</router-link></span> <span class="next"><router-link to="/icon/credit-card-minus.html">credit-card-minus</router-link>→</span></p></div>

...
zhTips: 箭头水平锁,滚动水平锁
tags: ["lock","arrow"]
search: scroll-horizontal-lock
image: https://iconhelper.cn/svg/material/arrow-horizontal-lock.svg
...
<p>关于“<b>arrow horizontal lock</b>”的评论:</p>
</div>
<Vssue title="关于“arrow horizontal lock”的评论" />    
<div><p>图标arrow horizontal lock来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/arrow-expand-vertical.html">arrow-expand-vertical</router-link></span> <span class="next"><router-link to="/icon/arrow-left.html">arrow-left</router-link>→</span></p></div>

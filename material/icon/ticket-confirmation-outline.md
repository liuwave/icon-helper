...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/ticket-confirmation.html">ticket-confirmation</router-link></span> <span class="next"><router-link to="/icon/ticket-outline.html">ticket-outline</router-link>→</span></p></div>

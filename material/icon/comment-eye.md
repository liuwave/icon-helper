...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/comment-edit-outline.html">comment-edit-outline</router-link></span> <span class="next"><router-link to="/icon/comment-eye-outline.html">comment-eye-outline</router-link>→</span></p></div>

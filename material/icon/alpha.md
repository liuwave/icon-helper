...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/allergy.html">allergy</router-link></span> <span class="next"><router-link to="/icon/alpha-a.html">alpha-a</router-link>→</span></p></div>

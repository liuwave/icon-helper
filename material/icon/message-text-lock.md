...
zhTips: 短信文本锁定,安全短信
tags: ["lock"]
search: message-text-secure
image: https://iconhelper.cn/svg/material/message-text-lock.svg
...
<p>关于“<b>message text lock</b>”的评论:</p>
</div>
<Vssue title="关于“message text lock”的评论" />    
<div><p>图标message text lock来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/message-text-clock-outline.html">message-text-clock-outline</router-link></span> <span class="next"><router-link to="/icon/message-text-lock-outline.html">message-text-lock-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/screw-round-top.html">screw-round-top</router-link></span> <span class="next"><router-link to="/icon/script.html">script</router-link>→</span></p></div>

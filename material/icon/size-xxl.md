...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/size-xs.html">size-xs</router-link></span> <span class="next"><router-link to="/icon/size-xxs.html">size-xxs</router-link>→</span></p></div>

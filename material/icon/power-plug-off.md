...
search: power-off
image: https://iconhelper.cn/svg/material/power-plug-off.svg
...
<p>关于“<b>power plug off</b>”的评论:</p>
</div>
<Vssue title="关于“power plug off”的评论" />    
<div><p>图标power plug off来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/power-plug.html">power-plug</router-link></span> <span class="next"><router-link to="/icon/power-settings.html">power-settings</router-link>→</span></p></div>

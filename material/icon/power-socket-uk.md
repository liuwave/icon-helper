...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/power-socket-jp.html">power-socket-jp</router-link></span> <span class="next"><router-link to="/icon/power-socket-us.html">power-socket-us</router-link>→</span></p></div>

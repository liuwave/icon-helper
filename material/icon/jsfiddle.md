...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/jquery.html">jquery</router-link></span> <span class="next"><router-link to="/icon/judaism.html">judaism</router-link>→</span></p></div>

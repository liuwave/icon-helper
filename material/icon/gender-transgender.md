...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gender-non-binary.html">gender-non-binary</router-link></span> <span class="next"><router-link to="/icon/gentoo.html">gentoo</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/numeric-9-plus-box.html">numeric-9-plus-box</router-link></span> <span class="next"><router-link to="/icon/numeric-9-plus-box-multiple-outline.html">numeric-9-plus-box-multiple-outline</router-link>→</span></p></div>

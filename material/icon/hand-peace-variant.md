...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hand-peace.html">hand-peace</router-link></span> <span class="next"><router-link to="/icon/hand-pointing-down.html">hand-pointing-down</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/football-helmet.html">football-helmet</router-link></span> <span class="next"><router-link to="/icon/format-align-bottom.html">format-align-bottom</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/material/toothbrush-paste.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/toothbrush-electric.html">toothbrush-electric</router-link></span> <span class="next"><router-link to="/icon/tortoise.html">tortoise</router-link>→</span></p></div>

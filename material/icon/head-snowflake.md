...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/head-remove-outline.html">head-remove-outline</router-link></span> <span class="next"><router-link to="/icon/head-snowflake-outline.html">head-snowflake-outline</router-link>→</span></p></div>

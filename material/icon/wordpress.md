...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wiper-wash.html">wiper-wash</router-link></span> <span class="next"><router-link to="/icon/wrap.html">wrap</router-link>→</span></p></div>

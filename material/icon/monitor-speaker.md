...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/monitor-screenshot.html">monitor-screenshot</router-link></span> <span class="next"><router-link to="/icon/monitor-speaker-off.html">monitor-speaker-off</router-link>→</span></p></div>

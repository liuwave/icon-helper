...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bus-alert.html">bus-alert</router-link></span> <span class="next"><router-link to="/icon/bus-articulated-front.html">bus-articulated-front</router-link>→</span></p></div>

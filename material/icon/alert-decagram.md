...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/alert-circle-outline.html">alert-circle-outline</router-link></span> <span class="next"><router-link to="/icon/alert-decagram-outline.html">alert-decagram-outline</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/material/battery-charging-wireless-alert.svg
...
<p>关于“<b>battery charging wireless alert</b>”的评论:</p>
</div>
<Vssue title="关于“battery charging wireless alert”的评论" />    
<div><p>图标battery charging wireless alert来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/battery-charging-wireless-90.html">battery-charging-wireless-90</router-link></span> <span class="next"><router-link to="/icon/battery-charging-wireless-outline.html">battery-charging-wireless-outline</router-link>→</span></p></div>

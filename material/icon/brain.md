...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/braille.html">braille</router-link></span> <span class="next"><router-link to="/icon/bread-slice.html">bread-slice</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bus-double-decker.html">bus-double-decker</router-link></span> <span class="next"><router-link to="/icon/bus-multiple.html">bus-multiple</router-link>→</span></p></div>

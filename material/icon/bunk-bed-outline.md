...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bunk-bed.html">bunk-bed</router-link></span> <span class="next"><router-link to="/icon/bus.html">bus</router-link>→</span></p></div>

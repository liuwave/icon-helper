...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/weather-windy-variant.html">weather-windy-variant</router-link></span> <span class="next"><router-link to="/icon/web-box.html">web-box</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tune-vertical.html">tune-vertical</router-link></span> <span class="next"><router-link to="/icon/turnstile-outline.html">turnstile-outline</router-link>→</span></p></div>

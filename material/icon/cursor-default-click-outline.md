...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cursor-default-click.html">cursor-default-click</router-link></span> <span class="next"><router-link to="/icon/cursor-default-gesture.html">cursor-default-gesture</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/blur-linear.html">blur-linear</router-link></span> <span class="next"><router-link to="/icon/blur-radial.html">blur-radial</router-link>→</span></p></div>

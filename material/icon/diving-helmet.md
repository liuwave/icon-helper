...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/diving-flippers.html">diving-flippers</router-link></span> <span class="next"><router-link to="/icon/diving-scuba.html">diving-scuba</router-link>→</span></p></div>

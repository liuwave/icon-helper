...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/car-wash.html">car-wash</router-link></span> <span class="next"><router-link to="/icon/car-windshield-outline.html">car-windshield-outline</router-link>→</span></p></div>

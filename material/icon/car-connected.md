...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/car-cog.html">car-cog</router-link></span> <span class="next"><router-link to="/icon/car-convertible.html">car-convertible</router-link>→</span></p></div>

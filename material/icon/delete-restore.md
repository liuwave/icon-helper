...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/delete-outline.html">delete-outline</router-link></span> <span class="next"><router-link to="/icon/delete-sweep.html">delete-sweep</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/set-left.html">set-left</router-link></span> <span class="next"><router-link to="/icon/set-left-right.html">set-left-right</router-link>→</span></p></div>

...
search: network-strength-2-warning
image: https://iconhelper.cn/svg/material/network-strength-2-alert.svg
...
<copy-btn content='F08F7' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F08F7", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/network-strength-2.html">network-strength-2</router-link></span> <span class="next"><router-link to="/icon/network-strength-3.html">network-strength-3</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tournament.html">tournament</router-link></span> <span class="next"><router-link to="/icon/tower-beach.html">tower-beach</router-link>→</span></p></div>

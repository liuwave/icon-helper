...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tooltip-edit.html">tooltip-edit</router-link></span> <span class="next"><router-link to="/icon/tooltip-image.html">tooltip-image</router-link>→</span></p></div>

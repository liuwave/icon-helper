...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/exclamation-thick.html">exclamation-thick</router-link></span> <span class="next"><router-link to="/icon/exit-to-app.html">exit-to-app</router-link>→</span></p></div>

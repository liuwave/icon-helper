...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/car-clutch.html">car-clutch</router-link></span> <span class="next"><router-link to="/icon/car-connected.html">car-connected</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sticker-remove.html">sticker-remove</router-link></span> <span class="next"><router-link to="/icon/stocking.html">stocking</router-link>→</span></p></div>

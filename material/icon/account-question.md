...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-plus-outline.html">account-plus-outline</router-link></span> <span class="next"><router-link to="/icon/account-question-outline.html">account-question-outline</router-link>→</span></p></div>

...
tags: []
search: 
image: https://iconhelper.cn/svg/material/shield-link-variant.svg
...
<p>关于“<b>shield link variant</b>”的评论:</p>
</div>
<Vssue title="关于“shield link variant”的评论" />    
<div><p>图标shield link variant来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/shield-key-outline.html">shield-key-outline</router-link></span> <span class="next"><router-link to="/icon/shield-link-variant-outline.html">shield-link-variant-outline</router-link>→</span></p></div>

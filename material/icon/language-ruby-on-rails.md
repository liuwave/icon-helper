...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/language-ruby.html">language-ruby</router-link></span> <span class="next"><router-link to="/icon/language-swift.html">language-swift</router-link>→</span></p></div>

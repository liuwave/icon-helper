...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/atom-variant.html">atom-variant</router-link></span> <span class="next"><router-link to="/icon/audio-video.html">audio-video</router-link>→</span></p></div>

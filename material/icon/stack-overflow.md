...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/stack-exchange.html">stack-exchange</router-link></span> <span class="next"><router-link to="/icon/stackpath.html">stackpath</router-link>→</span></p></div>

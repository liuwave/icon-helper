...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/thumb-up-outline.html">thumb-up-outline</router-link></span> <span class="next"><router-link to="/icon/ticket.html">ticket</router-link>→</span></p></div>

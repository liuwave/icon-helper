...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/jellyfish.html">jellyfish</router-link></span> <span class="next"><router-link to="/icon/jira.html">jira</router-link>→</span></p></div>

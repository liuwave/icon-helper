...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/checkerboard-remove.html">checkerboard-remove</router-link></span> <span class="next"><router-link to="/icon/cheese-off.html">cheese-off</router-link>→</span></p></div>

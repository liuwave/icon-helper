...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/spellcheck.html">spellcheck</router-link></span> <span class="next"><router-link to="/icon/spider-thread.html">spider-thread</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/weather-snowy-heavy.html">weather-snowy-heavy</router-link></span> <span class="next"><router-link to="/icon/weather-sunny.html">weather-sunny</router-link>→</span></p></div>

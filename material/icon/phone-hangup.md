...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/phone-forward-outline.html">phone-forward-outline</router-link></span> <span class="next"><router-link to="/icon/phone-hangup-outline.html">phone-hangup-outline</router-link>→</span></p></div>

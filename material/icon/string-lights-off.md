...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/string-lights.html">string-lights</router-link></span> <span class="next"><router-link to="/icon/subdirectory-arrow-left.html">subdirectory-arrow-left</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/swap-vertical-variant.html">swap-vertical-variant</router-link></span> <span class="next"><router-link to="/icon/switch.html">switch</router-link>→</span></p></div>

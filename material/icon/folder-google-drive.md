...
<copy-btn content='F024E' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F024E", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>folder google drive</b>”的评论:</p>
</div>
<Vssue title="关于“folder google drive”的评论" />    
<div><p>图标folder google drive来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/folder-edit-outline.html">folder-edit-outline</router-link></span> <span class="next"><router-link to="/icon/folder-heart.html">folder-heart</router-link>→</span></p></div>

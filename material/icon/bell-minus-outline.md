...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bell-minus.html">bell-minus</router-link></span> <span class="next"><router-link to="/icon/bell-off.html">bell-off</router-link>→</span></p></div>

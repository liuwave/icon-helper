...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/android-messages.html">android-messages</router-link></span> <span class="next"><router-link to="/icon/angle-acute.html">angle-acute</router-link>→</span></p></div>

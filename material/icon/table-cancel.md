...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/table-border.html">table-border</router-link></span> <span class="next"><router-link to="/icon/table-chair.html">table-chair</router-link>→</span></p></div>

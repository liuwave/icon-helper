...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/github.html">github</router-link></span> <span class="next"><router-link to="/icon/glass-cocktail.html">glass-cocktail</router-link>→</span></p></div>

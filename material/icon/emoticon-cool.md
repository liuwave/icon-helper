...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/emoticon-confused-outline.html">emoticon-confused-outline</router-link></span> <span class="next"><router-link to="/icon/emoticon-cool-outline.html">emoticon-cool-outline</router-link>→</span></p></div>

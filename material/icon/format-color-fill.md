...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/format-clear.html">format-clear</router-link></span> <span class="next"><router-link to="/icon/format-color-highlight.html">format-color-highlight</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/google-controller-off.html">google-controller-off</router-link></span> <span class="next"><router-link to="/icon/google-drive.html">google-drive</router-link>→</span></p></div>

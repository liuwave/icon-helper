...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/arrow-up-bold-box-outline.html">arrow-up-bold-box-outline</router-link></span> <span class="next"><router-link to="/icon/arrow-up-bold-circle-outline.html">arrow-up-bold-circle-outline</router-link>→</span></p></div>

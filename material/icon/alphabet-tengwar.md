...
image: https://iconhelper.cn/svg/material/alphabet-tengwar.svg
...
<p>关于“<b>alphabet tengwar</b>”的评论:</p>
</div>
<Vssue title="关于“alphabet tengwar”的评论" />    
<div><p>图标alphabet tengwar来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/alphabet-piqad.html">alphabet-piqad</router-link></span> <span class="next"><router-link to="/icon/alphabetical.html">alphabetical</router-link>→</span></p></div>

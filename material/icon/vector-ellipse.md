...
search: 
image: https://iconhelper.cn/svg/material/vector-ellipse.svg
...
<copy-btn content='F0893' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0893", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>vector ellipse</b>”的评论:</p>
</div>
<Vssue title="关于“vector ellipse”的评论" />    
<div><p>图标vector ellipse来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/vector-difference-ba.html">vector-difference-ba</router-link></span> <span class="next"><router-link to="/icon/vector-intersection.html">vector-intersection</router-link>→</span></p></div>

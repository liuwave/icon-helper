...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/white-balance-auto.html">white-balance-auto</router-link></span> <span class="next"><router-link to="/icon/white-balance-iridescent.html">white-balance-iridescent</router-link>→</span></p></div>

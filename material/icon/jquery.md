...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/jira.html">jira</router-link></span> <span class="next"><router-link to="/icon/jsfiddle.html">jsfiddle</router-link>→</span></p></div>

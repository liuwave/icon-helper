...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/youtube-gaming.html">youtube-gaming</router-link></span> <span class="next"><router-link to="/icon/youtube-subscription.html">youtube-subscription</router-link>→</span></p></div>

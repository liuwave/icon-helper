...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/radiator-disabled.html">radiator-disabled</router-link></span> <span class="next"><router-link to="/icon/radio.html">radio</router-link>→</span></p></div>

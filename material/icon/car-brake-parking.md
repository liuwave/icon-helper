...
tags: ["automotive"]
search: 
image: https://iconhelper.cn/svg/material/car-brake-parking.svg
...
<copy-btn content='F0D5F' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0D5F", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>car brake parking</b>”的评论:</p>
</div>
<Vssue title="关于“car brake parking”的评论" />    
<div><p>图标car brake parking来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/car-brake-hold.html">car-brake-hold</router-link></span> <span class="next"><router-link to="/icon/car-brake-retarder.html">car-brake-retarder</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cloud-upload-outline.html">cloud-upload-outline</router-link></span> <span class="next"><router-link to="/icon/coach-lamp.html">coach-lamp</router-link>→</span></p></div>

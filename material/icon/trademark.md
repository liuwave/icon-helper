...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tractor.html">tractor</router-link></span> <span class="next"><router-link to="/icon/traffic-cone.html">traffic-cone</router-link>→</span></p></div>

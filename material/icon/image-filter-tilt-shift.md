...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/image-filter-none.html">image-filter-none</router-link></span> <span class="next"><router-link to="/icon/image-filter-vintage.html">image-filter-vintage</router-link>→</span></p></div>

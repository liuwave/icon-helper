...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/boxing-glove.html">boxing-glove</router-link></span> <span class="next"><router-link to="/icon/brain.html">brain</router-link>→</span></p></div>

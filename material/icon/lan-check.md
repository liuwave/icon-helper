...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/lan.html">lan</router-link></span> <span class="next"><router-link to="/icon/lan-connect.html">lan-connect</router-link>→</span></p></div>

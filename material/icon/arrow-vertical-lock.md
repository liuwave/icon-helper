...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/arrow-up-thick.html">arrow-up-thick</router-link></span> <span class="next"><router-link to="/icon/artstation.html">artstation</router-link>→</span></p></div>

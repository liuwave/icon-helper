...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/dice-d8.html">dice-d8</router-link></span> <span class="next"><router-link to="/icon/dice-multiple.html">dice-multiple</router-link>→</span></p></div>

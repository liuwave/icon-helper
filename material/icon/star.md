...
<span>
CSS名称：
<span class="badge-secondary badge">mdi-star</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">F04CE</span> 
<copy-btn content='F04CE' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F04CE", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="mdi mdi-star" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="mdi mdi-star"
    style="font-size: 24px"
    aria-hidden="true"></i> mdi-star
    <copy-btn content="mdi-star" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<Vssue title="关于“star”的评论" />    
<div><p>图标star来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/standard-definition.html">standard-definition</router-link></span> <span class="next"><router-link to="/icon/star-box.html">star-box</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/power-socket.html">power-socket</router-link></span> <span class="next"><router-link to="/icon/power-socket-de.html">power-socket-de</router-link>→</span></p></div>

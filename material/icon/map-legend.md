...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/map-clock-outline.html">map-clock-outline</router-link></span> <span class="next"><router-link to="/icon/map-marker.html">map-marker</router-link>→</span></p></div>

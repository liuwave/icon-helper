...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/puzzle-outline.html">puzzle-outline</router-link></span> <span class="next"><router-link to="/icon/qqchat.html">qqchat</router-link>→</span></p></div>

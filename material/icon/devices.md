...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/deviantart.html">deviantart</router-link></span> <span class="next"><router-link to="/icon/diabetes.html">diabetes</router-link>→</span></p></div>

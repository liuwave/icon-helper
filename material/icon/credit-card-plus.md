...
tags: ["banking"]
search: 
image: https://iconhelper.cn/svg/material/credit-card-plus.svg
...
<p>关于“<b>credit card plus</b>”的评论:</p>
</div>
<Vssue title="关于“credit card plus”的评论" />    
<div><p>图标credit card plus来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/credit-card-outline.html">credit-card-outline</router-link></span> <span class="next"><router-link to="/icon/credit-card-plus-outline.html">credit-card-plus-outline</router-link>→</span></p></div>

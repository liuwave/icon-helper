...
tags: []
search: airline-seat-flat-angled
image: https://iconhelper.cn/svg/material/seat-flat-angled.svg
...
<copy-btn content='F047C' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F047C", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>seat flat angled</b>”的评论:</p>
</div>
<Vssue title="关于“seat flat angled”的评论" />    
<div><p>图标seat flat angled来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/seat-flat.html">seat-flat</router-link></span> <span class="next"><router-link to="/icon/seat-individual-suite.html">seat-individual-suite</router-link>→</span></p></div>

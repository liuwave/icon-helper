...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/book-cross.html">book-cross</router-link></span> <span class="next"><router-link to="/icon/book-lock.html">book-lock</router-link>→</span></p></div>

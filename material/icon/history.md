...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hinduism.html">hinduism</router-link></span> <span class="next"><router-link to="/icon/hockey-puck.html">hockey-puck</router-link>→</span></p></div>

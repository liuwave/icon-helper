...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/microphone-off.html">microphone-off</router-link></span> <span class="next"><router-link to="/icon/microphone-plus.html">microphone-plus</router-link>→</span></p></div>

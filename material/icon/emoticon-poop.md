...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/emoticon-outline.html">emoticon-outline</router-link></span> <span class="next"><router-link to="/icon/emoticon-poop-outline.html">emoticon-poop-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/ticket-account.html">ticket-account</router-link></span> <span class="next"><router-link to="/icon/ticket-confirmation-outline.html">ticket-confirmation-outline</router-link>→</span></p></div>

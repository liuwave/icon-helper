...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/power-socket-uk.html">power-socket-uk</router-link></span> <span class="next"><router-link to="/icon/power-standby.html">power-standby</router-link>→</span></p></div>

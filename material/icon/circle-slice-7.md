...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/circle-slice-6.html">circle-slice-6</router-link></span> <span class="next"><router-link to="/icon/circle-slice-8.html">circle-slice-8</router-link>→</span></p></div>

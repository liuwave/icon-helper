...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-circle-outline.html">account-circle-outline</router-link></span> <span class="next"><router-link to="/icon/account-clock-outline.html">account-clock-outline</router-link>→</span></p></div>

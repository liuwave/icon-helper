...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/expansion-card.html">expansion-card</router-link></span> <span class="next"><router-link to="/icon/exponent.html">exponent</router-link>→</span></p></div>

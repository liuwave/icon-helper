...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/redo-variant.html">redo-variant</router-link></span> <span class="next"><router-link to="/icon/reflect-vertical.html">reflect-vertical</router-link>→</span></p></div>

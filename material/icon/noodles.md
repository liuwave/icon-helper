...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/nodejs.html">nodejs</router-link></span> <span class="next"><router-link to="/icon/not-equal.html">not-equal</router-link>→</span></p></div>

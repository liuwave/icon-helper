...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wave.html">wave</router-link></span> <span class="next"><router-link to="/icon/waze.html">waze</router-link>→</span></p></div>

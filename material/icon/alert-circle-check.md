...
tags: ["alert-error"]
search: 
image: https://iconhelper.cn/svg/material/alert-circle-check.svg
...
<copy-btn content='F11ED' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F11ED", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>alert circle check</b>”的评论:</p>
</div>
<Vssue title="关于“alert circle check”的评论" />    
<div><p>图标alert circle check来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/alert-circle.html">alert-circle</router-link></span> <span class="next"><router-link to="/icon/alert-circle-check-outline.html">alert-circle-check-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/paw.html">paw</router-link></span> <span class="next"><router-link to="/icon/pdf-box.html">pdf-box</router-link>→</span></p></div>

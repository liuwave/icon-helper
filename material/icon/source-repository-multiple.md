...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/source-repository.html">source-repository</router-link></span> <span class="next"><router-link to="/icon/soy-sauce.html">soy-sauce</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/face-woman-outline.html">face-woman-outline</router-link></span> <span class="next"><router-link to="/icon/facebook-messenger.html">facebook-messenger</router-link>→</span></p></div>

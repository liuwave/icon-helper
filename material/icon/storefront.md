...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/store-outline.html">store-outline</router-link></span> <span class="next"><router-link to="/icon/storefront-outline.html">storefront-outline</router-link>→</span></p></div>

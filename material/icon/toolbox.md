...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/toilet.html">toilet</router-link></span> <span class="next"><router-link to="/icon/toolbox-outline.html">toolbox-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/kickstarter.html">kickstarter</router-link></span> <span class="next"><router-link to="/icon/knife.html">knife</router-link>→</span></p></div>

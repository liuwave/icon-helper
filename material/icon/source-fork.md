...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/source-commit-start-next-local.html">source-commit-start-next-local</router-link></span> <span class="next"><router-link to="/icon/source-merge.html">source-merge</router-link>→</span></p></div>

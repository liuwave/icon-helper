...
tags: ["science"]
search: 
image: https://iconhelper.cn/svg/material/eyedropper-minus.svg
...
<copy-btn content='F13DD' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F13DD", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/eyedropper.html">eyedropper</router-link></span> <span class="next"><router-link to="/icon/eyedropper-off.html">eyedropper-off</router-link>→</span></p></div>

...
tags: ["navigation"]
search: 
image: https://iconhelper.cn/svg/material/compass-rose.svg
...
<copy-btn content='F1382' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F1382", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>compass rose</b>”的评论:</p>
</div>
<Vssue title="关于“compass rose”的评论" />    
<div><p>图标compass rose来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/compass-outline.html">compass-outline</router-link></span> <span class="next"><router-link to="/icon/concourse-ci.html">concourse-ci</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/email-variant.html">email-variant</router-link></span> <span class="next"><router-link to="/icon/emby.html">emby</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/details.html">details</router-link></span> <span class="next"><router-link to="/icon/developer-board.html">developer-board</router-link>→</span></p></div>

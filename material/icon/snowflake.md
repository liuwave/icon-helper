...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/snowboard.html">snowboard</router-link></span> <span class="next"><router-link to="/icon/snowflake-alert.html">snowflake-alert</router-link>→</span></p></div>

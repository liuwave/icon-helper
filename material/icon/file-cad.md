...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/file-cabinet.html">file-cabinet</router-link></span> <span class="next"><router-link to="/icon/file-cad-box.html">file-cad-box</router-link>→</span></p></div>

...
tags: ["gaming-rpg"]
search: 
image: https://iconhelper.cn/svg/material/gamepad-variant.svg
...
<copy-btn content='F0297' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0297", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gamepad-up.html">gamepad-up</router-link></span> <span class="next"><router-link to="/icon/gamepad-variant-outline.html">gamepad-variant-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sticker-circle-outline.html">sticker-circle-outline</router-link></span> <span class="next"><router-link to="/icon/sticker-minus.html">sticker-minus</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-heart-outline.html">account-heart-outline</router-link></span> <span class="next"><router-link to="/icon/account-key-outline.html">account-key-outline</router-link>→</span></p></div>

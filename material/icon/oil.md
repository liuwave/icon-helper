...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/office-building.html">office-building</router-link></span> <span class="next"><router-link to="/icon/oil-lamp.html">oil-lamp</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bottle-soda-classic.html">bottle-soda-classic</router-link></span> <span class="next"><router-link to="/icon/bottle-soda-outline.html">bottle-soda-outline</router-link>→</span></p></div>

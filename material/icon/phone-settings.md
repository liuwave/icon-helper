...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/phone-rotate-portrait.html">phone-rotate-portrait</router-link></span> <span class="next"><router-link to="/icon/phone-settings-outline.html">phone-settings-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/truck-trailer.html">truck-trailer</router-link></span> <span class="next"><router-link to="/icon/tshirt-crew.html">tshirt-crew</router-link>→</span></p></div>

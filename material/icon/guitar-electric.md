...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/guitar-acoustic.html">guitar-acoustic</router-link></span> <span class="next"><router-link to="/icon/guitar-pick.html">guitar-pick</router-link>→</span></p></div>

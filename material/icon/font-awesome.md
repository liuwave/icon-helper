...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/folder-zip-outline.html">folder-zip-outline</router-link></span> <span class="next"><router-link to="/icon/food.html">food</router-link>→</span></p></div>

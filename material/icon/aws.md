...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/av-timer.html">av-timer</router-link></span> <span class="next"><router-link to="/icon/axe.html">axe</router-link>→</span></p></div>

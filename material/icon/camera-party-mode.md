...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/camera-outline.html">camera-outline</router-link></span> <span class="next"><router-link to="/icon/camera-plus.html">camera-plus</router-link>→</span></p></div>

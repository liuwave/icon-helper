...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/format-align-left.html">format-align-left</router-link></span> <span class="next"><router-link to="/icon/format-align-right.html">format-align-right</router-link>→</span></p></div>

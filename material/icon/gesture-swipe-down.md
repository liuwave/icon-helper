...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gesture-swipe.html">gesture-swipe</router-link></span> <span class="next"><router-link to="/icon/gesture-swipe-horizontal.html">gesture-swipe-horizontal</router-link>→</span></p></div>

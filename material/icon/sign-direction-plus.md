...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sign-direction-minus.html">sign-direction-minus</router-link></span> <span class="next"><router-link to="/icon/sign-direction-remove.html">sign-direction-remove</router-link>→</span></p></div>

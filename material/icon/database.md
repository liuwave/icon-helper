...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cursor-text.html">cursor-text</router-link></span> <span class="next"><router-link to="/icon/database-check.html">database-check</router-link>→</span></p></div>

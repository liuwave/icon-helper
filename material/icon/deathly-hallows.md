...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/death-star-variant.html">death-star-variant</router-link></span> <span class="next"><router-link to="/icon/debian.html">debian</router-link>→</span></p></div>

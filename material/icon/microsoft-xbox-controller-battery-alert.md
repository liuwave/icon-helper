...
image: https://iconhelper.cn/svg/material/microsoft-xbox-controller-battery-alert.svg
...
</span><br/><span>标签：<span class="badge-light badge"><router-link to="/tags/battery.html">电池</router-link></span><span class="badge-light badge"><router-link to="/tags/gaming-rpg.html">游戏、角色扮演</router-link></span><span class="badge-light badge"><router-link to="/tags/alert-error.html">警告、错误</router-link></span></span>
<br/>
...
</div><div class="description description alert alert-light">表示xbox控制器电池警告，电池不足</div>
...
<p>关于“<b>microsoft xbox controller battery alert</b>”的评论:</p>
</div>
<Vssue title="关于“microsoft xbox controller battery alert”的评论" />    
<div><p>图标microsoft xbox controller battery alert来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/android-debug-bridge.html">android-debug-bridge</router-link></span> <span class="next"><router-link to="/icon/android-studio.html">android-studio</router-link>→</span></p></div>

...
<span>
CSS名称：
<span class="badge-secondary badge">mdi-map-marker</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">F034E</span> 
<copy-btn content='F034E' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F034E", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="mdi mdi-map-marker" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="mdi mdi-map-marker"
    style="font-size: 24px"
    aria-hidden="true"></i> mdi-map-marker
    <copy-btn content="mdi-map-marker" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标map marker来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/map-legend.html">map-legend</router-link></span> <span class="next"><router-link to="/icon/map-marker-alert.html">map-marker-alert</router-link>→</span></p></div>

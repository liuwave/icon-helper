...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/lungs.html">lungs</router-link></span> <span class="next"><router-link to="/icon/magnet-on.html">magnet-on</router-link>→</span></p></div>

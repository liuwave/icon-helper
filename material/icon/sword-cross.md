...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sword.html">sword</router-link></span> <span class="next"><router-link to="/icon/syllabary-hangul.html">syllabary-hangul</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/brightness-4.html">brightness-4</router-link></span> <span class="next"><router-link to="/icon/brightness-6.html">brightness-6</router-link>→</span></p></div>

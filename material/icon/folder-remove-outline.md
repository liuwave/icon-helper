...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/folder-remove.html">folder-remove</router-link></span> <span class="next"><router-link to="/icon/folder-search.html">folder-search</router-link>→</span></p></div>

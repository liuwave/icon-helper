...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/map-marker-question.html">map-marker-question</router-link></span> <span class="next"><router-link to="/icon/map-marker-radius.html">map-marker-radius</router-link>→</span></p></div>

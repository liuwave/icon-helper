...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/comment.html">comment</router-link></span> <span class="next"><router-link to="/icon/comment-account-outline.html">comment-account-outline</router-link>→</span></p></div>

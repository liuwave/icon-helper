...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/movie-outline.html">movie-outline</router-link></span> <span class="next"><router-link to="/icon/movie-search.html">movie-search</router-link>→</span></p></div>

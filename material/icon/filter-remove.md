...
zhTips: 删除过滤器,删除漏斗
tags: []
search: funnel-remove
image: https://iconhelper.cn/svg/material/filter-remove.svg
...
<p>关于“<b>filter remove</b>”的评论:</p>
</div>
<Vssue title="关于“filter remove”的评论" />    
<div><p>图标filter remove来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/filter-plus-outline.html">filter-plus-outline</router-link></span> <span class="next"><router-link to="/icon/filter-remove-outline.html">filter-remove-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/car-key.html">car-key</router-link></span> <span class="next"><router-link to="/icon/car-light-fog.html">car-light-fog</router-link>→</span></p></div>

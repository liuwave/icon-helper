...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/rss-off.html">rss-off</router-link></span> <span class="next"><router-link to="/icon/ruler.html">ruler</router-link>→</span></p></div>

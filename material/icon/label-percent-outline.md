...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/label-percent.html">label-percent</router-link></span> <span class="next"><router-link to="/icon/label-variant.html">label-variant</router-link>→</span></p></div>

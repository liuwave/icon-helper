...
zhTips: 手势,手绘线
tags: ["drawing-art"]
search: freehand-line
image: https://iconhelper.cn/svg/material/gesture.svg
...
<p>关于“<b>gesture</b>”的评论:</p>
</div>
<Vssue title="关于“gesture”的评论" />    
<div><p>图标gesture来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gentoo.html">gentoo</router-link></span> <span class="next"><router-link to="/icon/gesture-double-tap.html">gesture-double-tap</router-link>→</span></p></div>

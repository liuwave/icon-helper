...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/opera.html">opera</router-link></span> <span class="next"><router-link to="/icon/order-alphabetical-ascending.html">order-alphabetical-ascending</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/memory.html">memory</router-link></span> <span class="next"><router-link to="/icon/menu-down.html">menu-down</router-link>→</span></p></div>

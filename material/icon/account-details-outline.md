...
image: https://iconhelper.cn/svg/material/account-details-outline.svg
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="mdi mdi-account-details-outline" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="mdi mdi-account-details-outline" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="mdi mdi-account-details-outline"
    style="font-size: 24px"
    aria-hidden="true"></i> mdi-account-details-outline
    <copy-btn content="mdi-account-details-outline" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
<div id="svg" class="svg-wrap">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11 9C11 10.66 9.66 12 8 12C6.34 12 5 10.66 5 9C5 7.34 6.34 6 8 6C9.66 6 11 7.34 11 9M14 20H2V18C2 15.79 4.69 14 8 14C11.31 14 14 15.79 14 18M7 9C7 9.55 7.45 10 8 10C8.55 10 9 9.55 9 9C9 8.45 8.55 8 8 8C7.45 8 7 8.45 7 9M4 18H12C12 16.9 10.21 16 8 16C5.79 16 4 16.9 4 18M22 12V14H13V12M22 8V10H13V8M22 4V6H13V4Z" /></svg>
</div>
<detail full-name='mdi-account-details-outline'></detail>
<div class="icon-detail__container">
<p>关于“<b>account details outline</b>”的评论:</p>
</div>
<Vssue title="关于“account details outline”的评论" />    
<div><p>图标account details outline来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-details.html">account-details</router-link></span> <span class="next"><router-link to="/icon/account-edit.html">account-edit</router-link>→</span></p></div>

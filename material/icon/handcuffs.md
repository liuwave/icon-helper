...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/handball.html">handball</router-link></span> <span class="next"><router-link to="/icon/handshake.html">handshake</router-link>→</span></p></div>

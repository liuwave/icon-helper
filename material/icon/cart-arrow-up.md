...
image: https://iconhelper.cn/svg/material/cart-arrow-up.svg
...
<copy-btn content='F0D67' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0D67", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>cart arrow up</b>”的评论:</p>
</div>
<Vssue title="关于“cart arrow up”的评论" />    
<div><p>图标cart arrow up来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cart-arrow-right.html">cart-arrow-right</router-link></span> <span class="next"><router-link to="/icon/cart-minus.html">cart-minus</router-link>→</span></p></div>

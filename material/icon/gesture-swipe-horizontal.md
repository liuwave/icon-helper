...
<p>关于“<b>gesture swipe horizontal</b>”的评论:</p>
</div>
<Vssue title="关于“gesture swipe horizontal”的评论" />    
<div><p>图标gesture swipe horizontal来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gesture-swipe-down.html">gesture-swipe-down</router-link></span> <span class="next"><router-link to="/icon/gesture-swipe-left.html">gesture-swipe-left</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/multiplication-box.html">multiplication-box</router-link></span> <span class="next"><router-link to="/icon/mushroom-off.html">mushroom-off</router-link>→</span></p></div>

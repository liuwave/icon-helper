...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/equalizer-outline.html">equalizer-outline</router-link></span> <span class="next"><router-link to="/icon/eraser-variant.html">eraser-variant</router-link>→</span></p></div>

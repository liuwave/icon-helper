...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/google-ads.html">google-ads</router-link></span> <span class="next"><router-link to="/icon/google-assistant.html">google-assistant</router-link>→</span></p></div>

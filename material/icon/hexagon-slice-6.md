...
tags: []
search: 
image: https://iconhelper.cn/svg/material/hexagon-slice-6.svg
...
<p>关于“<b>hexagon slice 6</b>”的评论:</p>
</div>
<Vssue title="关于“hexagon slice 6”的评论" />    
<div><p>图标hexagon slice 6来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hexagon-slice-5.html">hexagon-slice-5</router-link></span> <span class="next"><router-link to="/icon/hexagram.html">hexagram</router-link>→</span></p></div>

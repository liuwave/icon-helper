...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/glass-stange.html">glass-stange</router-link></span> <span class="next"><router-link to="/icon/glass-wine.html">glass-wine</router-link>→</span></p></div>

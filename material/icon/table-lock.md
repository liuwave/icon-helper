...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/table-large-remove.html">table-large-remove</router-link></span> <span class="next"><router-link to="/icon/table-merge-cells.html">table-merge-cells</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/qi.html">qi</router-link></span> <span class="next"><router-link to="/icon/qrcode.html">qrcode</router-link>→</span></p></div>

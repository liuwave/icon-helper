...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fullscreen-exit.html">fullscreen-exit</router-link></span> <span class="next"><router-link to="/icon/function-variant.html">function-variant</router-link>→</span></p></div>

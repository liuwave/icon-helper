...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/microsoft-internet-explorer.html">microsoft-internet-explorer</router-link></span> <span class="next"><router-link to="/icon/microsoft-onedrive.html">microsoft-onedrive</router-link>→</span></p></div>

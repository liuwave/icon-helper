...
tags: []
search: 
image: https://iconhelper.cn/svg/material/clipboard.svg
...
<span>
CSS名称：
<span class="badge-secondary badge">mdi-clipboard</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">F0147</span> 
<copy-btn content='F0147' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0147", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div class="alert alert-dark">
  ...
  <i class="mdi mdi-clipboard mdi-18px"></i>
</div>
<div>
  <p>引入css文件后，可以用<code>&lt;span&gt;</code>包裹，放在页面中。具体如下所示：    
  </p>
  <div class="alert alert-primary" style="font-size: 14px">
    &lt;span class="mdi mdi-clipboard" aria-hidden="true"&gt;&lt;/span&gt;
    <copy-btn content='<span class="mdi mdi-clipboard" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="mdi mdi-clipboard"
    style="font-size: 24px"
    aria-hidden="true"></i> mdi-clipboard
    <copy-btn content="mdi-clipboard" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<detail full-name='mdi-clipboard'></detail>
<div class="icon-detail__container">
<p>关于“<b>clipboard</b>”的评论:</p>
</div>
<Vssue title="关于“clipboard”的评论" />    
<div><p>图标clipboard来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/city-variant-outline.html">city-variant-outline</router-link></span> <span class="next"><router-link to="/icon/clipboard-account.html">clipboard-account</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hexagon-multiple.html">hexagon-multiple</router-link></span> <span class="next"><router-link to="/icon/hexagon-outline.html">hexagon-outline</router-link>→</span></p></div>

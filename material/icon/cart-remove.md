...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cart-plus.html">cart-plus</router-link></span> <span class="next"><router-link to="/icon/case-sensitive-alt.html">case-sensitive-alt</router-link>→</span></p></div>

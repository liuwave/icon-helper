...
# check circle  <small style="font-size: 60%;font-weight: 100">检查圆圈</small>
...
<span>
CSS名称：
<span class="badge-secondary badge">mdi-check-circle</span> 
</span>
<br/>
<span>
unicode：
<span class="badge-secondary badge">F05E0</span> 
<copy-btn content='F05E0' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F05E0", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div>
  ...
  <div class="alert alert-primary" style="font-size: 14px">
    ...
    <copy-btn content='<span class="mdi mdi-check-circle" aria-hidden="true"></span>'></copy-btn>
  </div>
  <div class="alert alert-secondary">
    <i class="mdi mdi-check-circle"
    style="font-size: 24px"
    aria-hidden="true"></i> mdi-check-circle
    <copy-btn content="mdi-check-circle" btn-title="复制图标名称"></copy-btn>
  </div>
</div>
...
<div><p>图标check circle来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/check-box-outline.html">check-box-outline</router-link></span> <span class="next"><router-link to="/icon/check-circle-outline.html">check-circle-outline</router-link>→</span></p></div>

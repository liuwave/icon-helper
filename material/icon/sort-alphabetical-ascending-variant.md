...
search: 
image: https://iconhelper.cn/svg/material/sort-alphabetical-ascending-variant.svg
...
<copy-btn content='F1148' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F1148", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>sort alphabetical ascending variant</b>”的评论:</p>
</div>
<Vssue title="关于“sort alphabetical ascending variant”的评论" />    
<div><p>图标sort alphabetical ascending variant来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sort-alphabetical-ascending.html">sort-alphabetical-ascending</router-link></span> <span class="next"><router-link to="/icon/sort-alphabetical-descending.html">sort-alphabetical-descending</router-link>→</span></p></div>

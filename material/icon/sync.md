...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/symfony.html">symfony</router-link></span> <span class="next"><router-link to="/icon/sync-alert.html">sync-alert</router-link>→</span></p></div>

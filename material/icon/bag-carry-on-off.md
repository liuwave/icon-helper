...
image: https://iconhelper.cn/svg/material/bag-carry-on-off.svg
...
<p>关于“<b>bag carry on off</b>”的评论:</p>
</div>
<Vssue title="关于“bag carry on off”的评论" />    
<div><p>图标bag carry on off来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bag-carry-on-check.html">bag-carry-on-check</router-link></span> <span class="next"><router-link to="/icon/bag-checked.html">bag-checked</router-link>→</span></p></div>

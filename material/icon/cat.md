...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/castle.html">castle</router-link></span> <span class="next"><router-link to="/icon/cctv.html">cctv</router-link>→</span></p></div>

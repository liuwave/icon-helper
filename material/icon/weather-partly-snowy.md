...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/weather-partly-rainy.html">weather-partly-rainy</router-link></span> <span class="next"><router-link to="/icon/weather-partly-snowy-rainy.html">weather-partly-snowy-rainy</router-link>→</span></p></div>

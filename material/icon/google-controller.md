...
tags: ["gaming-rpg"]
search: 
image: https://iconhelper.cn/svg/material/google-controller.svg
...
<p>关于“<b>google controller</b>”的评论:</p>
</div>
<Vssue title="关于“google controller”的评论" />    
<div><p>图标google controller来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/google-cloud.html">google-cloud</router-link></span> <span class="next"><router-link to="/icon/google-controller-off.html">google-controller-off</router-link>→</span></p></div>

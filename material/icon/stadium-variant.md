...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/stadium.html">stadium</router-link></span> <span class="next"><router-link to="/icon/stairs.html">stairs</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/chair-school.html">chair-school</router-link></span> <span class="next"><router-link to="/icon/chart-arc.html">chart-arc</router-link>→</span></p></div>

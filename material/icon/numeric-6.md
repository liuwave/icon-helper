...
<p>关于“<b>numeric 6</b>”的评论:</p>
</div>
<Vssue title="关于“numeric 6”的评论" />    
<div><p>图标numeric 6来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/numeric-5-circle-outline.html">numeric-5-circle-outline</router-link></span> <span class="next"><router-link to="/icon/numeric-6-box.html">numeric-6-box</router-link>→</span></p></div>

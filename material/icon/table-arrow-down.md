...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/table-alert.html">table-alert</router-link></span> <span class="next"><router-link to="/icon/table-arrow-left.html">table-arrow-left</router-link>→</span></p></div>

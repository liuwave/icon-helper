...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/flower.html">flower</router-link></span> <span class="next"><router-link to="/icon/flower-poppy.html">flower-poppy</router-link>→</span></p></div>

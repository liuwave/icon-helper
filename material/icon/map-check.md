...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/map.html">map</router-link></span> <span class="next"><router-link to="/icon/map-check-outline.html">map-check-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/printer-settings.html">printer-settings</router-link></span> <span class="next"><router-link to="/icon/priority-high.html">priority-high</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/eslint.html">eslint</router-link></span> <span class="next"><router-link to="/icon/ethereum.html">ethereum</router-link>→</span></p></div>

...
tags: ["alpha-numeric"]
search: 
image: https://iconhelper.cn/svg/material/alphabetical-variant.svg
...
<copy-btn content='F100D' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F100D", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>alphabetical variant</b>”的评论:</p>
</div>
<Vssue title="关于“alphabetical variant”的评论" />    
<div><p>图标alphabetical variant来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/alphabetical-off.html">alphabetical-off</router-link></span> <span class="next"><router-link to="/icon/alphabetical-variant-off.html">alphabetical-variant-off</router-link>→</span></p></div>

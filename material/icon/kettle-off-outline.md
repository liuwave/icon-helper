...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/kettle-off.html">kettle-off</router-link></span> <span class="next"><router-link to="/icon/kettle-outline.html">kettle-outline</router-link>→</span></p></div>

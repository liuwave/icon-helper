...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/overscan.html">overscan</router-link></span> <span class="next"><router-link to="/icon/pac-man.html">pac-man</router-link>→</span></p></div>

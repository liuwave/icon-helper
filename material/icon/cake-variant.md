...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cake-layered.html">cake-layered</router-link></span> <span class="next"><router-link to="/icon/calculator.html">calculator</router-link>→</span></p></div>

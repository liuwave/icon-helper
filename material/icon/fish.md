...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/firework.html">firework</router-link></span> <span class="next"><router-link to="/icon/fish-off.html">fish-off</router-link>→</span></p></div>

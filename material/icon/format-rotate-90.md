...
image: https://iconhelper.cn/svg/material/format-rotate-90.svg
...
<p>关于“<b>format rotate 90</b>”的评论:</p>
</div>
<Vssue title="关于“format rotate 90”的评论" />    
<div><p>图标format rotate 90来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/format-quote-open-outline.html">format-quote-open-outline</router-link></span> <span class="next"><router-link to="/icon/format-section.html">format-section</router-link>→</span></p></div>

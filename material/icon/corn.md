...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cordova.html">cordova</router-link></span> <span class="next"><router-link to="/icon/corn-off.html">corn-off</router-link>→</span></p></div>

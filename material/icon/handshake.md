...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/handcuffs.html">handcuffs</router-link></span> <span class="next"><router-link to="/icon/hanger.html">hanger</router-link>→</span></p></div>

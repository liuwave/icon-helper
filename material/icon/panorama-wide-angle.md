...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/panorama-vertical.html">panorama-vertical</router-link></span> <span class="next"><router-link to="/icon/paper-cut-vertical.html">paper-cut-vertical</router-link>→</span></p></div>

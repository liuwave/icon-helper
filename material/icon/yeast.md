...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/yahoo.html">yahoo</router-link></span> <span class="next"><router-link to="/icon/yin-yang.html">yin-yang</router-link>→</span></p></div>

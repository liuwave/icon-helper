...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/library-shelves.html">library-shelves</router-link></span> <span class="next"><router-link to="/icon/lifebuoy.html">lifebuoy</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/alpha-w-circle.html">alpha-w-circle</router-link></span> <span class="next"><router-link to="/icon/alpha-x.html">alpha-x</router-link>→</span></p></div>

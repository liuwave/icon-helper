...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/quora.html">quora</router-link></span> <span class="next"><router-link to="/icon/racing-helmet.html">racing-helmet</router-link>→</span></p></div>

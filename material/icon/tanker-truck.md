...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tank.html">tank</router-link></span> <span class="next"><router-link to="/icon/tape-measure.html">tape-measure</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/video-image.html">video-image</router-link></span> <span class="next"><router-link to="/icon/video-input-component.html">video-input-component</router-link>→</span></p></div>

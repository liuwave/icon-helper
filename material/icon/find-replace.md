...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/finance.html">finance</router-link></span> <span class="next"><router-link to="/icon/fingerprint.html">fingerprint</router-link>→</span></p></div>

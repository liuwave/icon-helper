...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/human-female.html">human-female</router-link></span> <span class="next"><router-link to="/icon/human-female-female.html">human-female-female</router-link>→</span></p></div>

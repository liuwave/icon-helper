...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/lightbulb-off.html">lightbulb-off</router-link></span> <span class="next"><router-link to="/icon/lightbulb-on.html">lightbulb-on</router-link>→</span></p></div>

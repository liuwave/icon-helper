...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/guitar-pick.html">guitar-pick</router-link></span> <span class="next"><router-link to="/icon/guy-fawkes-mask.html">guy-fawkes-mask</router-link>→</span></p></div>

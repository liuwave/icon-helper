...
tags: ["banking"]
search: 
image: https://iconhelper.cn/svg/material/safe.svg
...
<copy-btn content='F0A6A' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0A6A", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<Vssue title="关于“safe”的评论" />    
<div><p>图标safe来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sack-percent.html">sack-percent</router-link></span> <span class="next"><router-link to="/icon/safe-square.html">safe-square</router-link>→</span></p></div>

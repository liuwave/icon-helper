...
tags: ["sport"]
search: 
image: https://iconhelper.cn/svg/material/scoreboard.svg
...
<p>关于“<b>scoreboard</b>”的评论:</p>
</div>
<Vssue title="关于“scoreboard”的评论" />    
<div><p>图标scoreboard来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/scooter.html">scooter</router-link></span> <span class="next"><router-link to="/icon/scoreboard-outline.html">scoreboard-outline</router-link>→</span></p></div>

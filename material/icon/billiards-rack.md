...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/billiards.html">billiards</router-link></span> <span class="next"><router-link to="/icon/binoculars.html">binoculars</router-link>→</span></p></div>

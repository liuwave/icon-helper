...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/skip-previous-outline.html">skip-previous-outline</router-link></span> <span class="next"><router-link to="/icon/skull-crossbones.html">skull-crossbones</router-link>→</span></p></div>

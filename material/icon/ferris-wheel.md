...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fedora.html">fedora</router-link></span> <span class="next"><router-link to="/icon/ferry.html">ferry</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/language-java.html">language-java</router-link></span> <span class="next"><router-link to="/icon/language-kotlin.html">language-kotlin</router-link>→</span></p></div>

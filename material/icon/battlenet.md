...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/battery-unknown-bluetooth.html">battery-unknown-bluetooth</router-link></span> <span class="next"><router-link to="/icon/beach.html">beach</router-link>→</span></p></div>

...
tags: ["brand-logo"]
search: 
image: https://iconhelper.cn/svg/material/whatsapp.svg
...
<copy-btn content='F05A3' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F05A3", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">whatsapp</span><span class="badge-primary badge">瓦次普</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/material/whatsapp.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/material/whatsapp.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
...
<div><p>图标whatsapp来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/weight-pound.html">weight-pound</router-link></span> <span class="next"><router-link to="/icon/wheelchair-accessibility.html">wheelchair-accessibility</router-link>→</span></p></div>

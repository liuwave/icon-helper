...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/vector-union.html">vector-union</router-link></span> <span class="next"><router-link to="/icon/vibrate.html">vibrate</router-link>→</span></p></div>

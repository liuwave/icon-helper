...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/go-kart-track.html">go-kart-track</router-link></span> <span class="next"><router-link to="/icon/gold.html">gold</router-link>→</span></p></div>

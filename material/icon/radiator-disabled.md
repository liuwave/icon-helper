...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/radiator.html">radiator</router-link></span> <span class="next"><router-link to="/icon/radiator-off.html">radiator-off</router-link>→</span></p></div>

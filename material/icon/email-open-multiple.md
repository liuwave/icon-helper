...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/email-open.html">email-open</router-link></span> <span class="next"><router-link to="/icon/email-open-multiple-outline.html">email-open-multiple-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bugle.html">bugle</router-link></span> <span class="next"><router-link to="/icon/bullet.html">bullet</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/circle-slice-5.html">circle-slice-5</router-link></span> <span class="next"><router-link to="/icon/circle-slice-7.html">circle-slice-7</router-link>→</span></p></div>

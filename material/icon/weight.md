...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wechat.html">wechat</router-link></span> <span class="next"><router-link to="/icon/weight-gram.html">weight-gram</router-link>→</span></p></div>

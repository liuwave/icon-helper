...
image: https://iconhelper.cn/svg/material/shape-outline.svg
...
<p>关于“<b>shape outline</b>”的评论:</p>
</div>
<Vssue title="关于“shape outline”的评论" />    
<div><p>图标shape outline来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/shape-circle-plus.html">shape-circle-plus</router-link></span> <span class="next"><router-link to="/icon/shape-oval-plus.html">shape-oval-plus</router-link>→</span></p></div>

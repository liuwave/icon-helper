...
tags: ["notification"]
search: 
image: https://iconhelper.cn/svg/material/bell-cancel.svg
...
<p>关于“<b>bell cancel</b>”的评论:</p>
</div>
<Vssue title="关于“bell cancel”的评论" />    
<div><p>图标bell cancel来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bell-alert-outline.html">bell-alert-outline</router-link></span> <span class="next"><router-link to="/icon/bell-cancel-outline.html">bell-cancel-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/diving-scuba-tank-multiple.html">diving-scuba-tank-multiple</router-link></span> <span class="next"><router-link to="/icon/division.html">division</router-link>→</span></p></div>

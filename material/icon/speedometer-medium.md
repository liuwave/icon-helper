...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/speedometer.html">speedometer</router-link></span> <span class="next"><router-link to="/icon/speedometer-slow.html">speedometer-slow</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hiking.html">hiking</router-link></span> <span class="next"><router-link to="/icon/history.html">history</router-link>→</span></p></div>

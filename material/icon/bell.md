...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/beer-outline.html">beer-outline</router-link></span> <span class="next"><router-link to="/icon/bell-alert.html">bell-alert</router-link>→</span></p></div>

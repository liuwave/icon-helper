...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/restart.html">restart</router-link></span> <span class="next"><router-link to="/icon/restart-off.html">restart-off</router-link>→</span></p></div>

...
tags: ["settings"]
search: psychology
image: https://iconhelper.cn/svg/material/head-cog.svg
...
<p>关于“<b>head cog</b>”的评论:</p>
</div>
<Vssue title="关于“head cog”的评论" />    
<div><p>图标head cog来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/head-check-outline.html">head-check-outline</router-link></span> <span class="next"><router-link to="/icon/head-cog-outline.html">head-cog-outline</router-link>→</span></p></div>

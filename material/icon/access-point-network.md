...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/access-point.html">access-point</router-link></span> <span class="next"><router-link to="/icon/access-point-network-off.html">access-point-network-off</router-link>→</span></p></div>

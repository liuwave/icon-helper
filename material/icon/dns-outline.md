...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/dns.html">dns</router-link></span> <span class="next"><router-link to="/icon/do-not-disturb.html">do-not-disturb</router-link>→</span></p></div>

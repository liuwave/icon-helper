...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hospital-marker.html">hospital-marker</router-link></span> <span class="next"><router-link to="/icon/hubspot.html">hubspot</router-link>→</span></p></div>

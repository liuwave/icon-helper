...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/console.html">console</router-link></span> <span class="next"><router-link to="/icon/console-network.html">console-network</router-link>→</span></p></div>

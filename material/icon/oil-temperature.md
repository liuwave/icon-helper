...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/oil-level.html">oil-level</router-link></span> <span class="next"><router-link to="/icon/omega.html">omega</router-link>→</span></p></div>

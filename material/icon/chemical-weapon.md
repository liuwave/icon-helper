...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/chef-hat.html">chef-hat</router-link></span> <span class="next"><router-link to="/icon/chess-bishop.html">chess-bishop</router-link>→</span></p></div>

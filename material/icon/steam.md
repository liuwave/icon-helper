...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/state-machine.html">state-machine</router-link></span> <span class="next"><router-link to="/icon/steering.html">steering</router-link>→</span></p></div>

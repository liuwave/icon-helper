...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/voicemail.html">voicemail</router-link></span> <span class="next"><router-link to="/icon/volume-high.html">volume-high</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bomb.html">bomb</router-link></span> <span class="next"><router-link to="/icon/bone.html">bone</router-link>→</span></p></div>

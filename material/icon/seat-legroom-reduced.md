...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/seat-legroom-normal.html">seat-legroom-normal</router-link></span> <span class="next"><router-link to="/icon/seat-outline.html">seat-outline</router-link>→</span></p></div>

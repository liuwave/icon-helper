...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/textbox-lock.html">textbox-lock</router-link></span> <span class="next"><router-link to="/icon/texture.html">texture</router-link>→</span></p></div>

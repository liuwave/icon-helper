...
search: cold-alert,snow-advisory,freeze-advisory
image: https://iconhelper.cn/svg/material/snowflake-alert.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/snowflake.html">snowflake</router-link></span> <span class="next"><router-link to="/icon/snowflake-melt.html">snowflake-melt</router-link>→</span></p></div>

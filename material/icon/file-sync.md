...
<p>关于“<b>file sync</b>”的评论:</p>
</div>
<Vssue title="关于“file sync”的评论" />    
<div><p>图标file sync来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/file-swap-outline.html">file-swap-outline</router-link></span> <span class="next"><router-link to="/icon/file-sync-outline.html">file-sync-outline</router-link>→</span></p></div>

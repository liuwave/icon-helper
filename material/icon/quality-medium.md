...
image: https://iconhelper.cn/svg/material/quality-medium.svg
...
<copy-btn content='F0A0D' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0A0D", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/quality-low.html">quality-low</router-link></span> <span class="next"><router-link to="/icon/quora.html">quora</router-link>→</span></p></div>

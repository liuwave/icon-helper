...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/seal-variant.html">seal-variant</router-link></span> <span class="next"><router-link to="/icon/seat.html">seat</router-link>→</span></p></div>

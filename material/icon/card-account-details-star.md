...
tags: ["account-user"]
search: 
image: https://iconhelper.cn/svg/material/card-account-details-star.svg
...
<p>关于“<b>card account details star</b>”的评论:</p>
</div>
<Vssue title="关于“card account details star”的评论" />    
<div><p>图标card account details star来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/card-account-details-outline.html">card-account-details-outline</router-link></span> <span class="next"><router-link to="/icon/card-account-details-star-outline.html">card-account-details-star-outline</router-link>→</span></p></div>

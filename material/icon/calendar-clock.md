...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/calendar-check-outline.html">calendar-check-outline</router-link></span> <span class="next"><router-link to="/icon/calendar-edit.html">calendar-edit</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-multiple-outline.html">account-multiple-outline</router-link></span> <span class="next"><router-link to="/icon/account-multiple-plus-outline.html">account-multiple-plus-outline</router-link>→</span></p></div>

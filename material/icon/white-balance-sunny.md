...
tags: ["photography"]
search: wb-sunny
image: https://iconhelper.cn/svg/material/white-balance-sunny.svg
...
<p>关于“<b>white balance sunny</b>”的评论:</p>
</div>
<Vssue title="关于“white balance sunny”的评论" />    
<div><p>图标white balance sunny来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/white-balance-iridescent.html">white-balance-iridescent</router-link></span> <span class="next"><router-link to="/icon/widgets.html">widgets</router-link>→</span></p></div>

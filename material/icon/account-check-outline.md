...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-check.html">account-check</router-link></span> <span class="next"><router-link to="/icon/account-child.html">account-child</router-link>→</span></p></div>

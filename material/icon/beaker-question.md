...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/beaker-plus-outline.html">beaker-plus-outline</router-link></span> <span class="next"><router-link to="/icon/beaker-question-outline.html">beaker-question-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wrap-disabled.html">wrap-disabled</router-link></span> <span class="next"><router-link to="/icon/wrench-outline.html">wrench-outline</router-link>→</span></p></div>

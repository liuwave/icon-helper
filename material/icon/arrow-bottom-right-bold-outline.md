...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/arrow-bottom-right.html">arrow-bottom-right</router-link></span> <span class="next"><router-link to="/icon/arrow-bottom-right-thick.html">arrow-bottom-right-thick</router-link>→</span></p></div>

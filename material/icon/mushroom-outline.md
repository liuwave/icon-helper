...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/mushroom-off-outline.html">mushroom-off-outline</router-link></span> <span class="next"><router-link to="/icon/music.html">music</router-link>→</span></p></div>

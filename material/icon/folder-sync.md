...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/folder-swap-outline.html">folder-swap-outline</router-link></span> <span class="next"><router-link to="/icon/folder-sync-outline.html">folder-sync-outline</router-link>→</span></p></div>

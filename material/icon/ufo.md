...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/ubuntu.html">ubuntu</router-link></span> <span class="next"><router-link to="/icon/ufo-outline.html">ufo-outline</router-link>→</span></p></div>

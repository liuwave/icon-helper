...
tags: ["automotive"]
search: 
image: https://iconhelper.cn/svg/material/hydraulic-oil-level.svg
...
<copy-btn content='F1324' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F1324", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hvac.html">hvac</router-link></span> <span class="next"><router-link to="/icon/hydraulic-oil-temperature.html">hydraulic-oil-temperature</router-link>→</span></p></div>

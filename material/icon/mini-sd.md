...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/minecraft.html">minecraft</router-link></span> <span class="next"><router-link to="/icon/minidisc.html">minidisc</router-link>→</span></p></div>

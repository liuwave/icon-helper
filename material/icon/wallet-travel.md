...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wallet-plus-outline.html">wallet-plus-outline</router-link></span> <span class="next"><router-link to="/icon/wallpaper.html">wallpaper</router-link>→</span></p></div>

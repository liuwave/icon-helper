...
<copy-btn content='F0A9C' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0A9C", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>cash refund</b>”的评论:</p>
</div>
<Vssue title="关于“cash refund”的评论" />    
<div><p>图标cash refund来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cash-plus.html">cash-plus</router-link></span> <span class="next"><router-link to="/icon/cash-register.html">cash-register</router-link>→</span></p></div>

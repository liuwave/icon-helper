...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wifi.html">wifi</router-link></span> <span class="next"><router-link to="/icon/wifi-star.html">wifi-star</router-link>→</span></p></div>

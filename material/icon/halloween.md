...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/hair-dryer-outline.html">hair-dryer-outline</router-link></span> <span class="next"><router-link to="/icon/hamburger.html">hamburger</router-link>→</span></p></div>

...
image: https://iconhelper.cn/svg/material/tray-full.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tray-alert.html">tray-alert</router-link></span> <span class="next"><router-link to="/icon/tray-minus.html">tray-minus</router-link>→</span></p></div>

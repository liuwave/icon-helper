...
tags: ["shopping"]
search: trolley,local-grocery-store,shopping-cart
image: https://iconhelper.cn/svg/material/cart.svg
...
<Vssue title="关于“cart”的评论" />    
<div><p>图标cart来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/carrot.html">carrot</router-link></span> <span class="next"><router-link to="/icon/cart-arrow-down.html">cart-arrow-down</router-link>→</span></p></div>

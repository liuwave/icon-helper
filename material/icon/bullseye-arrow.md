...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bullseye.html">bullseye</router-link></span> <span class="next"><router-link to="/icon/bulma.html">bulma</router-link>→</span></p></div>

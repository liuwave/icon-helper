...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wifi-strength-alert-outline.html">wifi-strength-alert-outline</router-link></span> <span class="next"><router-link to="/icon/wifi-strength-off.html">wifi-strength-off</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/kabaddi.html">kabaddi</router-link></span> <span class="next"><router-link to="/icon/keg.html">keg</router-link>→</span></p></div>

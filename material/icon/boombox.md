...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/boom-gate-up-outline.html">boom-gate-up-outline</router-link></span> <span class="next"><router-link to="/icon/boomerang.html">boomerang</router-link>→</span></p></div>

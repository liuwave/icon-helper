...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/calendar-range-outline.html">calendar-range-outline</router-link></span> <span class="next"><router-link to="/icon/calendar-refresh-outline.html">calendar-refresh-outline</router-link>→</span></p></div>

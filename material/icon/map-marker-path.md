...
search: 
image: https://iconhelper.cn/svg/material/map-marker-path.svg
...
<p>关于“<b>map marker path</b>”的评论:</p>
</div>
<Vssue title="关于“map marker path”的评论" />    
<div><p>图标map marker path来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/map-marker-outline.html">map-marker-outline</router-link></span> <span class="next"><router-link to="/icon/map-marker-plus.html">map-marker-plus</router-link>→</span></p></div>

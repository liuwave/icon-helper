...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/air-conditioner.html">air-conditioner</router-link></span> <span class="next"><router-link to="/icon/air-horn.html">air-horn</router-link>→</span></p></div>

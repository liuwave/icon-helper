...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/server-security.html">server-security</router-link></span> <span class="next"><router-link to="/icon/set-center.html">set-center</router-link>→</span></p></div>

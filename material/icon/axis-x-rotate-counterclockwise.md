...
tags: []
search: 
image: https://iconhelper.cn/svg/material/axis-x-rotate-counterclockwise.svg
...
<copy-btn content='F0D4F' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0D4F", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<p>关于“<b>axis x rotate counterclockwise</b>”的评论:</p>
</div>
<Vssue title="关于“axis x rotate counterclockwise”的评论" />    
<div><p>图标axis x rotate counterclockwise来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/axis-x-rotate-clockwise.html">axis-x-rotate-clockwise</router-link></span> <span class="next"><router-link to="/icon/axis-x-y-arrow-lock.html">axis-x-y-arrow-lock</router-link>→</span></p></div>

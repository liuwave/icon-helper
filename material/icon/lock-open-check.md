...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/lock-open-alert.html">lock-open-alert</router-link></span> <span class="next"><router-link to="/icon/lock-open-outline.html">lock-open-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/select-drag.html">select-drag</router-link></span> <span class="next"><router-link to="/icon/select-inverse.html">select-inverse</router-link>→</span></p></div>

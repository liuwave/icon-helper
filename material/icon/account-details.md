...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-cowboy-hat.html">account-cowboy-hat</router-link></span> <span class="next"><router-link to="/icon/account-details-outline.html">account-details-outline</router-link>→</span></p></div>

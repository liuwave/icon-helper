...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/marker.html">marker</router-link></span> <span class="next"><router-link to="/icon/marker-check.html">marker-check</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/scale.html">scale</router-link></span> <span class="next"><router-link to="/icon/scale-bathroom.html">scale-bathroom</router-link>→</span></p></div>

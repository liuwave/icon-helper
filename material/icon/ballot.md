...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/balloon.html">balloon</router-link></span> <span class="next"><router-link to="/icon/ballot-outline.html">ballot-outline</router-link>→</span></p></div>

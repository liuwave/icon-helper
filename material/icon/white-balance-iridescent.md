...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/white-balance-incandescent.html">white-balance-incandescent</router-link></span> <span class="next"><router-link to="/icon/white-balance-sunny.html">white-balance-sunny</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/nintendo-wiiu.html">nintendo-wiiu</router-link></span> <span class="next"><router-link to="/icon/nodejs.html">nodejs</router-link>→</span></p></div>

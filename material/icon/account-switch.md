...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-supervisor-outline.html">account-supervisor-outline</router-link></span> <span class="next"><router-link to="/icon/account-switch-outline.html">account-switch-outline</router-link>→</span></p></div>

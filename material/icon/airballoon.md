...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/airbag.html">airbag</router-link></span> <span class="next"><router-link to="/icon/airballoon-outline.html">airballoon-outline</router-link>→</span></p></div>

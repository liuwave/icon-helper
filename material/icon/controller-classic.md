...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/contrast-circle.html">contrast-circle</router-link></span> <span class="next"><router-link to="/icon/controller-classic-outline.html">controller-classic-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/folder-cog.html">folder-cog</router-link></span> <span class="next"><router-link to="/icon/folder-download.html">folder-download</router-link>→</span></p></div>

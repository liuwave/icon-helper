...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sync.html">sync</router-link></span> <span class="next"><router-link to="/icon/sync-circle.html">sync-circle</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/page-previous-outline.html">page-previous-outline</router-link></span> <span class="next"><router-link to="/icon/palette-advanced.html">palette-advanced</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gauge-full.html">gauge-full</router-link></span> <span class="next"><router-link to="/icon/gavel.html">gavel</router-link>→</span></p></div>

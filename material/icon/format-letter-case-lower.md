...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/format-letter-case.html">format-letter-case</router-link></span> <span class="next"><router-link to="/icon/format-letter-case-upper.html">format-letter-case-upper</router-link>→</span></p></div>

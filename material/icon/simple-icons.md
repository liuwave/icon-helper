...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sim-off.html">sim-off</router-link></span> <span class="next"><router-link to="/icon/sina-weibo.html">sina-weibo</router-link>→</span></p></div>

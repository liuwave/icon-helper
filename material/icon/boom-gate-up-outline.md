...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/boom-gate-up.html">boom-gate-up</router-link></span> <span class="next"><router-link to="/icon/boombox.html">boombox</router-link>→</span></p></div>

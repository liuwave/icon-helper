...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/copyright.html">copyright</router-link></span> <span class="next"><router-link to="/icon/corn.html">corn</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cellphone-text.html">cellphone-text</router-link></span> <span class="next"><router-link to="/icon/celtic-cross.html">celtic-cross</router-link>→</span></p></div>

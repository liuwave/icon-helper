...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/eye-minus-outline.html">eye-minus-outline</router-link></span> <span class="next"><router-link to="/icon/eye-off-outline.html">eye-off-outline</router-link>→</span></p></div>

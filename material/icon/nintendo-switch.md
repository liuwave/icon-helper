...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/nintendo-game-boy.html">nintendo-game-boy</router-link></span> <span class="next"><router-link to="/icon/nintendo-wii.html">nintendo-wii</router-link>→</span></p></div>

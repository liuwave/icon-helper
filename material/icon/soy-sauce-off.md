...
tags: []
search: 
image: https://iconhelper.cn/svg/material/soy-sauce-off.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/soy-sauce.html">soy-sauce</router-link></span> <span class="next"><router-link to="/icon/spa.html">spa</router-link>→</span></p></div>

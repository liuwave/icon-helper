...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/table-clock.html">table-clock</router-link></span> <span class="next"><router-link to="/icon/table-column.html">table-column</router-link>→</span></p></div>

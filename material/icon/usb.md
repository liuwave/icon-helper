...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/upload-outline.html">upload-outline</router-link></span> <span class="next"><router-link to="/icon/usb-flash-drive.html">usb-flash-drive</router-link>→</span></p></div>

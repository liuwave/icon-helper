...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/unfold-less-horizontal.html">unfold-less-horizontal</router-link></span> <span class="next"><router-link to="/icon/unfold-more-horizontal.html">unfold-more-horizontal</router-link>→</span></p></div>

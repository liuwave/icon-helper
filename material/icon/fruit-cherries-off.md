...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fruit-cherries.html">fruit-cherries</router-link></span> <span class="next"><router-link to="/icon/fruit-citrus.html">fruit-citrus</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cube-outline.html">cube-outline</router-link></span> <span class="next"><router-link to="/icon/cube-send.html">cube-send</router-link>→</span></p></div>

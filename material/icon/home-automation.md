...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/home-assistant.html">home-assistant</router-link></span> <span class="next"><router-link to="/icon/home-circle.html">home-circle</router-link>→</span></p></div>

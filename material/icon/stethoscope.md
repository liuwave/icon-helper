...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/step-forward-2.html">step-forward-2</router-link></span> <span class="next"><router-link to="/icon/sticker.html">sticker</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cloud-question.html">cloud-question</router-link></span> <span class="next"><router-link to="/icon/cloud-search.html">cloud-search</router-link>→</span></p></div>

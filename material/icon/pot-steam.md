...
tags: ["food-drink"]
search: 
image: https://iconhelper.cn/svg/material/pot-steam.svg
...
<p>关于“<b>pot steam</b>”的评论:</p>
</div>
<Vssue title="关于“pot steam”的评论" />    
<div><p>图标pot steam来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/pot-outline.html">pot-outline</router-link></span> <span class="next"><router-link to="/icon/pot-steam-outline.html">pot-steam-outline</router-link>→</span></p></div>

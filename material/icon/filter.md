...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/filmstrip-off.html">filmstrip-off</router-link></span> <span class="next"><router-link to="/icon/filter-menu.html">filter-menu</router-link>→</span></p></div>

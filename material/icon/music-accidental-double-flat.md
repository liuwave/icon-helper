...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/music.html">music</router-link></span> <span class="next"><router-link to="/icon/music-accidental-double-sharp.html">music-accidental-double-sharp</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/guitar-pick-outline.html">guitar-pick-outline</router-link></span> <span class="next"><router-link to="/icon/hail.html">hail</router-link>→</span></p></div>

...
tags: ["settings"]
search: 
image: https://iconhelper.cn/svg/material/content-save-settings.svg
...
<p>关于“<b>content save settings</b>”的评论:</p>
</div>
<Vssue title="关于“content save settings”的评论" />    
<div><p>图标content save settings来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/content-save-outline.html">content-save-outline</router-link></span> <span class="next"><router-link to="/icon/content-save-settings-outline.html">content-save-settings-outline</router-link>→</span></p></div>

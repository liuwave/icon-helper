...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/scatter-plot.html">scatter-plot</router-link></span> <span class="next"><router-link to="/icon/school.html">school</router-link>→</span></p></div>

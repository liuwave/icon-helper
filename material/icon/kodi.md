...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/knife-military.html">knife-military</router-link></span> <span class="next"><router-link to="/icon/kubernetes.html">kubernetes</router-link>→</span></p></div>

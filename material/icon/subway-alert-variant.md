...
image: https://iconhelper.cn/svg/material/subway-alert-variant.svg
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/subway.html">subway</router-link></span> <span class="next"><router-link to="/icon/subway-variant.html">subway-variant</router-link>→</span></p></div>

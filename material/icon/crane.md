...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/cpu-64-bit.html">cpu-64-bit</router-link></span> <span class="next"><router-link to="/icon/creation.html">creation</router-link>→</span></p></div>

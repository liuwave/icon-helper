...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/layers-search-outline.html">layers-search-outline</router-link></span> <span class="next"><router-link to="/icon/layers-triple-outline.html">layers-triple-outline</router-link>→</span></p></div>

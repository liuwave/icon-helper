...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gesture-swipe-left.html">gesture-swipe-left</router-link></span> <span class="next"><router-link to="/icon/gesture-swipe-up.html">gesture-swipe-up</router-link>→</span></p></div>

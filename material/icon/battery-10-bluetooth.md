...
zhTips: 电池10蓝牙,蓝牙电量10%
tags: ["battery"]
search: 
image: https://iconhelper.cn/svg/material/battery-10-bluetooth.svg
...
<br/>
<span class="zh-detail">中文描述：<span class="badge-primary badge">电池10蓝牙</span><span class="badge-primary badge">蓝牙电量10%</span><span class="help-link"><span>帮助改进</span>(<a href="https://gitee.com/liuwave/icon-helper/edit/master/json/material/battery-10-bluetooth.json" target="_blank" rel="noopener noreferrer">gitee</a><a href="https://github.com/liuwave/icon-helper/edit/master/json/material/battery-10-bluetooth.json" target="_blank" rel="noopener noreferrer">github</a></span>)</span><br/>
</p>
</div><div class="description description alert alert-light">表示蓝牙只有10%的电量</div>
...
<p>关于“<b>battery 10 bluetooth</b>”的评论:</p>
</div>
<Vssue title="关于“battery 10 bluetooth”的评论" />    
<div><p>图标battery 10 bluetooth来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/battery-10.html">battery-10</router-link></span> <span class="next"><router-link to="/icon/battery-20.html">battery-20</router-link>→</span></p></div>

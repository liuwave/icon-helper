...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/podium-silver.html">podium-silver</router-link></span> <span class="next"><router-link to="/icon/pokeball.html">pokeball</router-link>→</span></p></div>

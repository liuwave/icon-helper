...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/foot-print.html">foot-print</router-link></span> <span class="next"><router-link to="/icon/football-australian.html">football-australian</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/ski-cross-country.html">ski-cross-country</router-link></span> <span class="next"><router-link to="/icon/skip-backward.html">skip-backward</router-link>→</span></p></div>

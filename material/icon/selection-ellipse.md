...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/selection-drag.html">selection-drag</router-link></span> <span class="next"><router-link to="/icon/selection-ellipse-arrow-inside.html">selection-ellipse-arrow-inside</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/account-music-outline.html">account-music-outline</router-link></span> <span class="next"><router-link to="/icon/account-network-outline.html">account-network-outline</router-link>→</span></p></div>

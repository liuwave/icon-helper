...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/grain.html">grain</router-link></span> <span class="next"><router-link to="/icon/graph-outline.html">graph-outline</router-link>→</span></p></div>

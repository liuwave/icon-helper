...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/bottle-tonic-plus-outline.html">bottle-tonic-plus-outline</router-link></span> <span class="next"><router-link to="/icon/bottle-tonic-skull-outline.html">bottle-tonic-skull-outline</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/church.html">church</router-link></span> <span class="next"><router-link to="/icon/circle.html">circle</router-link>→</span></p></div>

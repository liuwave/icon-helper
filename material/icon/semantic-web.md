...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/selection-search.html">selection-search</router-link></span> <span class="next"><router-link to="/icon/send.html">send</router-link>→</span></p></div>

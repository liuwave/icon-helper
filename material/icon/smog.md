...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/smart-card-reader-outline.html">smart-card-reader-outline</router-link></span> <span class="next"><router-link to="/icon/smoke-detector.html">smoke-detector</router-link>→</span></p></div>

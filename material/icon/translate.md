...
<div><p>图标translate来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/transition-masked.html">transition-masked</router-link></span> <span class="next"><router-link to="/icon/translate-off.html">translate-off</router-link>→</span></p></div>

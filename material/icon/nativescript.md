...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/nas.html">nas</router-link></span> <span class="next"><router-link to="/icon/nature.html">nature</router-link>→</span></p></div>

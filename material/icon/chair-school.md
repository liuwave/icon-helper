...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/chair-rolling.html">chair-rolling</router-link></span> <span class="next"><router-link to="/icon/charity.html">charity</router-link>→</span></p></div>

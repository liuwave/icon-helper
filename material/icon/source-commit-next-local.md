...
tags: []
search: 
image: https://iconhelper.cn/svg/material/source-commit-next-local.svg
...
<p>关于“<b>source commit next local</b>”的评论:</p>
</div>
<Vssue title="关于“source commit next local”的评论" />    
<div><p>图标source commit next local来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/source-commit-local.html">source-commit-local</router-link></span> <span class="next"><router-link to="/icon/source-commit-start.html">source-commit-start</router-link>→</span></p></div>

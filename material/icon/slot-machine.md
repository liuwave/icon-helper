...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/slope-uphill.html">slope-uphill</router-link></span> <span class="next"><router-link to="/icon/slot-machine-outline.html">slot-machine-outline</router-link>→</span></p></div>

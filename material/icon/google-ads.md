...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/google.html">google</router-link></span> <span class="next"><router-link to="/icon/google-analytics.html">google-analytics</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/gesture-tap-box.html">gesture-tap-box</router-link></span> <span class="next"><router-link to="/icon/gesture-tap-hold.html">gesture-tap-hold</router-link>→</span></p></div>

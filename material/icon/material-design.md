...
tags: []
search: 
image: https://iconhelper.cn/svg/material/material-design.svg
...
<copy-btn content='F0986' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0986", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div><p>图标material design来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/mastodon.html">mastodon</router-link></span> <span class="next"><router-link to="/icon/material-ui.html">material-ui</router-link>→</span></p></div>

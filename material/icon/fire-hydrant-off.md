...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/fire-hydrant-alert.html">fire-hydrant-alert</router-link></span> <span class="next"><router-link to="/icon/fire-truck.html">fire-truck</router-link>→</span></p></div>

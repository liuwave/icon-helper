...
tags: ["music"]
search: 
image: https://iconhelper.cn/svg/material/music-note-sixteenth-dotted.svg
...
<copy-btn content='F0F76' btn-title=""></copy-btn>
<copy-btn :content='String.fromCodePoint(parseInt("F0F76", 16))' btn-title="复制U"></copy-btn>
</span>
<br/>
<span>
版本：
...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/music-note-sixteenth.html">music-note-sixteenth</router-link></span> <span class="next"><router-link to="/icon/music-note-whole.html">music-note-whole</router-link>→</span></p></div>

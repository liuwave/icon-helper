...
search: jolly-roger
image: https://iconhelper.cn/svg/material/skull-crossbones.svg
...
<p>关于“<b>skull crossbones</b>”的评论:</p>
</div>
<Vssue title="关于“skull crossbones”的评论" />    
<div><p>图标skull crossbones来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/skull.html">skull</router-link></span> <span class="next"><router-link to="/icon/skull-crossbones-outline.html">skull-crossbones-outline</router-link>→</span></p></div>

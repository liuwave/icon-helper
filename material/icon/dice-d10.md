...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/dice-6-outline.html">dice-6-outline</router-link></span> <span class="next"><router-link to="/icon/dice-d10-outline.html">dice-d10-outline</router-link>→</span></p></div>

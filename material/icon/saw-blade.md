...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/sausage.html">sausage</router-link></span> <span class="next"><router-link to="/icon/saxophone.html">saxophone</router-link>→</span></p></div>

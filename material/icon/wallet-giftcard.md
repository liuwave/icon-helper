...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/wallet.html">wallet</router-link></span> <span class="next"><router-link to="/icon/wallet-membership.html">wallet-membership</router-link>→</span></p></div>

...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/seat-recline-normal.html">seat-recline-normal</router-link></span> <span class="next"><router-link to="/icon/security.html">security</router-link>→</span></p></div>

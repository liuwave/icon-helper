...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/heart-outline.html">heart-outline</router-link></span> <span class="next"><router-link to="/icon/helicopter.html">helicopter</router-link>→</span></p></div>

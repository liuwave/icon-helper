...
image: https://iconhelper.cn/svg/material/book-plus-multiple.svg
...
<p>关于“<b>book plus multiple</b>”的评论:</p>
</div>
<Vssue title="关于“book plus multiple”的评论" />    
<div><p>图标book plus multiple来源于Material Design Icons，可免费使用，更多关于 Material Design Icons的信息，参见：<a target="_blank" href="https://iconhelper.cn/material.html"> Material Design Icons</a>
</p></div>

<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/book-plus.html">book-plus</router-link></span> <span class="next"><router-link to="/icon/book-plus-multiple-outline.html">book-plus-multiple-outline</router-link>→</span></p></div>

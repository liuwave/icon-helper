...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/spade.html">spade</router-link></span> <span class="next"><router-link to="/icon/speaker-bluetooth.html">speaker-bluetooth</router-link>→</span></p></div>

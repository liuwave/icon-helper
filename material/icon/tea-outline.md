...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/tea.html">tea</router-link></span> <span class="next"><router-link to="/icon/teach.html">teach</router-link>→</span></p></div>

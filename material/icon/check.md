...
<div style="padding:2rem 0 " class="page-nav"><p class="inner"><span class="prev">←<router-link to="/icon/chat-sleep-outline.html">chat-sleep-outline</router-link></span> <span class="next"><router-link to="/icon/check-all.html">check-all</router-link>→</span></p></div>
